...
const SelectableText = ({ children }: { children: any }) =>  <Text> {children} </Text>;

const StyledSelectableText = styled(SelectableText, {
    width: '100%', 
    display: 'flex', 
    fd: 'row', 
    jc: 'space-between', 
...
export const StyledSelectableText = StyledSelectableText