...
type IAccessibleIconWithTooltipProps = {
    ...
    otherProps: IconProps & TooltipProps;
}

type IAccessibleIconWithTooltipProps = Omit<IAccessibleIconProps, 'otherProps'> & IconProps
...
export const IconWithTooltip = (props: IAccessibleIconWithTooltipProps) => {
    let { label, children, ...otherProps } = props
