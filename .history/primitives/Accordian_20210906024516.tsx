...
const StyledTrigger = React.forwardRef(({ children, ...props }, forwardedRef) => (
    <StyledHeader>
...
const StyledContent = React.forwardRef(({ children, ...props }, forwardedRef) => (
...
export const AccordionTrigger = StyledTrigger
