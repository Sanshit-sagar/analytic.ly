...
export const ListBoxItemDescriptionListBoxItemLabel = ({ leftSlot, middleSlot, rightSlot, props }: IListBoxItemProps) => (
    <label {...props}>
        <Text size='2' css={{ color: '$text', display: 'flex', flexDirection: 'row', jc: 'space-evenly', gap: '$1', flexWrap: 'nowrap' }}> 
            <Text css={{ maxWidth: '30%', textOverflow: 'ellipses', overflow: 'hidden' }}> {leftSlot} </Text>
            <DotFilledIcon /> 
            <Text css={{ maxWidth: '30%', textOverflow: 'ellipses', overflow: 'hidden' }}> {middleSlot} </Text>
            <DotFilledIcon /> 
            <Text css={{ maxWidth: '30%', textOverflow: 'ellipses', overflow: 'hidden' }}> {rightSlot} </Text>
        </Text>
    </label>
);
