...
export const ListBoxItemDescription = ({ leftSlot, rightSlot, props }: IListBoxItemProps) => (
    <label {...props}>
        <Flex css={{ width: '100%', height: '1.5em', display: 'inline-flex', fd: 'row', jc: 'space-between', ai: 'center' }}>
            <Text css={{ color: '$text',  margin: 0, padding: 0, fontSize: '1em', display: 'flex', fd: 'row', jc: 'flex-end', ai: 'center', fontStyle: 'oblique', fontWeight: 'lighter'}}> 
                {leftSlot} 
            </Text>
        
            {/* <Text css={{ width: '100%', display: 'flex', fd: 'row', jc: 'flex-end', ai: 'center'}}> {rightSlot}</Text> */}
        </Flex>
    </label>
);
