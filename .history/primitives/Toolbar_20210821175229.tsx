...
const itemStyles = {
  ...
  '&:hover': { backgroundColor: green.green3, color: green.green11 },
  '&:focus': { position: 'relative', boxShadow: `0 0 0 2px ${green.green7}` },
};
const StyledButton = styled(
    ...
    { '&:hover': { color: 'white', backgroundColor: green.green7 } }
  );
