...
export const SectionLabel Name = styled('label', {
    fontWeight: 'bolder', 
...
// export const ListBoxItemDescription = ({ slot, props }: SectionLabelProps) => (
//     <StyledLabel {...props}><StyledDescription> {slot} </StyledDescription> </StyledLabel>
// );

// export const ListBoxItemLabel = ({ itemName, props }: SectionDescriptionProps) => (
