...
export const ListBoxItemDescription = ({ leftSlot, middleSlot, rightSlot, props }: IListBoxItemProps) => (
    <label {...props}>
        <Text size='1' css={{ width: '100%', color: '$text', display: 'flex', flexDirection: 'row', jc: 'space-between', ai: 'flex-start', gap: '$1', flexWrap: 'nowrap' }}> 
            <Text css={{ width: '100%', textOverflow: 'ellipses', overflow: 'hidden', float:'left', display: 'flex', fd: 'row', jc: 'flex-start', ai: 'center' }}> 
                {leftSlot} 
                <DotFilledIcon /> 
            </Text>
            
        
            <Text css={{ width: '45%', textOverflow: 'ellipses', overflow: 'hidden', display: 'flex', fd: 'row', jc: 'center', ai: 'center' }}> 
                {rightSlot} 
            </Text>
        </Text>
    </label>
...
export const ListBoxItemLabel = ({ itemName = 'item1', props }: IListBoxItemProps) => (
    <Text 
        {...props} 
        size='2' 
        css={{ 
