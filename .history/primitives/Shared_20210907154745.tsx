...
export const FlexStartCenterRow = styled('div', {
    display: 'flex', 
    fd: 'row',
    jc: 'flex-start',
    ai: 'center',
...
export const FlexEndCenterRow = styled('div', {
    display: 'flex', 
    fd: 'row',
    jc: 'flex-end',
    ai: 'center',
...
export const FlexCenterCenterRow = styled('div', {
    display: 'flex',
    fd: 'row', 
    jc: 'center', 
    ai: 'center', 
...
export const FlexStartCenterColumn = styled('div', {
    display: 'flex', 
    fd: 'column',
    jc: 'flex-start',
    ai: 'center',
...
export const FlexEndCenterColumn = styled('div', {
    display: 'flex', 
    fd: 'column',
    jc: 'flex-end',
    ai: 'center',
...
export const FlexCenterCenterColumn = styled('div', {
    display: 'flex',
    fd: 'column', 
    jc: 'center', 
    ai: 'center', 
...
export const DatePickerWrapper = styled('div', {
    margin: 'auto';
    display: 'flex';
    border: 'thin solid', borderColor: '$border', borderRadius: '$2', '&:hover': { }
<DayPickerInput 
})
