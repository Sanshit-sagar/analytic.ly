...
export const ListBoxItemDescription = ({ leftSlot, middleSlot, rightSlot, props }: IListBoxItemProps) => (
    <label {...props}>
        <Text size='2' css={{ width: '100%', color: '$text', display: 'flex', flexDirection: 'row', jc: 'flex-start', ai: 'flex-start', gap: '$1', flexWrap: 'nowrap' }}> 
            <Text css={{ width: '30%', textOverflow: 'ellipses', overflow: 'hidden' }}> {leftSlot} </Text>
            <DotFilledIcon /> 
            ...
            {middleSlot && (
                <>
                    {middleSlot} 
                   <Text css={{ color: '$funkyText'}}> <DotFilledIcon /> </Text>
                </Text>
            )}

            <Text css={{ width: '30%', textOverflow: 'ellipses', overflow: 'hidden' }}> 
                {rightSlot} 
            </Text>
        </Text>
    </label>
