...
export const ListBoxItemLabel = ({ leftSlot, middleSlot, rightSlot, props }: IListBoxItemProps) => (
    <label {...props}>
        <Text size='2' css={{ color: '$text', display: 'flex', flexDirection: 'row', jc: 'space-evenly', gap: '$1', flexWrap: 'no-wrap' }}> 
