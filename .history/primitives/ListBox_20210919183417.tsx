        ...
        >
            <Flex css={{ fd: 'row', jc: 'flex-start', ai: 'flex-start', gap: '$1' }}>
                <Text 
                    ...
                    size='2'
                    css={{ 
                        fontWeight: 500, textTransform: 'uppercase', color: '$funkyText', fontSize: '0.75em', 
...
export const ListBoxItemDescription = ({ leftSlot, rightSlot, props }: IListBoxItemProps) => (
    <label {...props}>
        ...
        <Flex 
            css={{ width: '100%', height: '1.5em', display: 'flex', flexDirection: 'row', jc: 'space-between', ai: 'center', flexWrap: 'nowrap' 
            }}
        > 
            <Text css={{ color: '$text',  margin: 0, padding: 0, fontSize: '1em', fontStyle: 'oblique', fontWeight: 'lighter'}}> 
                {leftSlot} 
            </Text>
