...
export const SlugInfo = ({ slug }: SlugDetails) => {
    ...
    return (
        <SlugDetailsContainer>
            <Tree name={details.expiration} icon={<ClockIcon />} defaultOpen />
            <Tree name={details.password} icon={<LockClosedIcon />} defaultOpen />
            <Tree name={details.slug} icon={<IdCardefaultOpen />
            <Tree name={details.createdAt} icon={<StarIcon />}  defaultOpen />
        </SlugDetailsContainer>
    )
}