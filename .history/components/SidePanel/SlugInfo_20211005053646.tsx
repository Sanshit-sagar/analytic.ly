...
const NodeText = ({ children }: { children: string }) => {
    return (
...
export const SlugInfo = ({ slug }: { slug: string }) => {
    ...
    return (
        <SlugDetailsContainer>
            ...
            <Tree name={<NodeText text={details.expiration}/>details.password} icon={<LockClosedIcon />} defaultOpen />
            <Tree name={<NodeText text={details.expiration}/>details.createdAt} icon={<ClockIcon />}  defaultOpen />
        </SlugDetailsContainer>
    )
}