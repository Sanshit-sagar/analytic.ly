...
const UrlResults = () => {
    ...
    return (
        <Tree name={'Destination'} level={1}>
            <Tree name={urlResults} level={2} /> 
        </Tree>
    );
}
const ExpirationResults = () => {
    ...
    return (
        <Tree name={'Expiration'} level={1}>
            <Tree name={expirationResults} level={2} /> 
        </Tree>
    );
}
const PasswordResults = () => {
    ...
    return (
        <Tree name={'Password'} level={1}>
            <Tree name={passwordResults} level={2} />
        </Tree>
    );
}
