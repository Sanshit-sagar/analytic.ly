...
import { CountdownTimerIcon, LockClosedIcon, ClockIcon } from '@radix-ui/react-icons'
...
export const SlugInfo = ({ slug }: SlugDetails) => {
    ...
    return (
        <SlugDetailsContainer>
            <Tree name={details.expiration} icon={<CountdownTimerIcon />} defaultOpen />
            <Tree name={details.password} icon={<LockClosedIcon />} defaultOpen />
            <Tree name={details.slug} icon={} defaultOpen />
