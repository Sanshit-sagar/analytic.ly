...
const CollectionWrapper = ({ collectionType, collectionName, swrProps }: { collectionType: CollectionType; collectionName: CollectionName; }) => {
    ...
    return (
        <ScrollArea>
            <CollectionContainer>
                ...
                ? <Mapping data={data} loading={loading} error={error} />
                : <Listing data={data} loading={loading} error={error} />
                }
            </CollectionContainer>
        </ScrollArea>
    )
...
export const SavedSlugs = () => {
    ...
    return <CollectionWrapper name={'Slugs'}  /> 
}


export const SavedDestinations = () => {
    const { data, loading, error }: SwrResponse = useSavedDestinations()
    return <CollectionWrapper name={'Destination URLs'} data={data} loading={loading} error={error} /> 
}