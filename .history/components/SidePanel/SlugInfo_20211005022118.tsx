...
function deserialize(data: { createdAt: number; destination: string; email: string; expiration: string; password: string; slug: string; url: string; }): SlugDetails | undefined {
