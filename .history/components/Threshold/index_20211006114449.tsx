...
const slugSelectionAtom = atom(INIT_SELECTION_STATE) // init selections to not loading, not selected 
const slugFetchEndpointsAtom = atom((get) => get(slugSelectionAtom).map((ssa: StoredSlugState) => '')) //init fetchEndpoints to empty string for each selection
