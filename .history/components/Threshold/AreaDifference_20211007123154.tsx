...
import { ClickDate, ClickScore } from '../Timeseries/interfaces'
            ...
            <svg height={height} width={width}>
                ...
                >
                    ...
                    <Threshold<CityTemperature>
                        ...
                        y0={(d: CityTemperature) => temperatureScale(groupA(d)) ?? 0}
                        y1={(d: CityTemperature) => temperatureScale(groupB(d)) ?? 0}
                        clipAboveTo={0}
                        clipBelowTo={yMax}
                        curve={curveBasis}
                        belowAreaProps={{
                    ...
                    <LinePath
                        ...
                        curve={curveBasis}
                        x={(d: CityTemperature) => timeScale(date(d)) ?? 0}
                        y={(d: CityTemperature) => temperatureScale(groupA(d)) ?? 0}
                        stroke={colors.text}
                        strokeWidth={1.5}
                        strokeOpacity={0.8}
                        strokeDasharray="1,2"
                   ...
                   <LinePath
                        ...
                        curve={curveBasis}
                        x={(d: CityTemperature) => timeScale(date(d)) ?? 0}
                        y={(d: CityTemperature) => temperatureScale(groupB(d)) ?? 0}
                        stroke={colors.text}
                        strokeWidth={1.5}
                    />
                </Group>
