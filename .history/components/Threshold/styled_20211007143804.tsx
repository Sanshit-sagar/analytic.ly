...
T extends React.ElementType, P extends object = {}> = Omit<React.ComponentPropsWithRef<T>, keyof P> & P;
...
type ContainerProps = MergeProps<"button", SmallContainerProps | LargeContainerProps>;
