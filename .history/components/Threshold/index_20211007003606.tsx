...
const SlugSelector = ({ 
    ...
    const handleUpdate = (value: number) => toast.success(`Selected ${value}, [${userSlugs[value]}]`)
...
const SelectionMenu = ({ userSlugs }: { userSlugs: string[]; }) => (
    <MenuBar> 
        ...
        <SlugSelector 
            ...
            userSlugs={userSlugs} 
            selectedIndex={4}
            endpoint={`http://localhost:3000/api/metrics/slug/brave-delay-damage-7rgys/views`}
        />
    </MenuBar>
)
