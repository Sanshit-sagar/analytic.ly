...
const formatSlugViews = (views: MockView[]): number[] => {
    return views.map((view, i) => new Date(view.timestamp).getUTCDate())
}

export const Tester = () => {
    let groupAData: number[] = formatSlugViews(mockViewsA.views)
    let groupBData: number[] = formatSlugViews(mockViewsB.views)
