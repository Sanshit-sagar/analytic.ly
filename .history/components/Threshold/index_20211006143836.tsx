...
const SlugSelector = ({ 
    ...
    const [selection, setSelection] = useState<string | undefined>(selectedIndex===undefined ? undefined : userSlugs[selectedIndex])
    ...
    return (
        <SelectMenu
            ...
            selectedTextValue={`${slugItems[selectedIndex || 0]?.textValue ?? slugItems[0].textValue}`}
            selectedValue={`${slugItems[selectedIndex || 0]?.value ?? slugItems[0].value}`}
        /> 
    )
}
