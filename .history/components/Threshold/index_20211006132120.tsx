...
const selectedSlugsAtom = atom(INIT_SELECTION_STATE)
const slugSelectionAtom = atom(
    (get) => get(selectedSlugsAtom),
    (_get, set, update: SlugState) => {
        return set(selectedSlugsAtom, update)
    }
); 

 //init fetchEndpoints to empty string for each selection
const slugFetchEndpointsAtom = atom(
