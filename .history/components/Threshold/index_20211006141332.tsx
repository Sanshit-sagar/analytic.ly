...
const isIndexInRange: boolean = (index: number, itemsInRange: any[]): boolean => index >= 0 && index <itemsInRange?.length;
const isEqual = (index1: number, index2: number): boolean => index1===index2
...
const SlugSelector = ({ 
    ...
    const handleIndexUpdate = (updatedIndex: number) => {  
        if(isIndexInRange(updatedIndex, slugItems)) {
