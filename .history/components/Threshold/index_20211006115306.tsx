...
const slugFetchEndpointsAtom = atom((get) => Object.keys(get(slugSelectionAtom)).map((slug: StoredSlugState) => ''))
...
const filteredSlugClicksUrlsAtom = atom(
    ...
    (get, set, update) => {
        set(slugFetchEndpointsAtom, Object.values(get(slugSelectionAtom)).map((slugState: StoredSlugState) => { 
