...
const makeSelectionAtom = atom({
    null,
    (_get, set, update: { slug: string, value: string | undefined; }) => {
...
const SlugSelector = ({ 
    ...
    const slugSelections = useUpdateValue(slugSelectionAtom)

    const [selectedIndex, setSelectedIndex] = React.useState(slugId)
    const handleIndexUpdate = (updatedIndex: number) => setSelectedIndex(`${updatedIndex}`)   
