...
const isEqual(index1: number, index2: number) => index1===index2
...
const SlugSelector = ({ 
    ...
    const handleIndexUpdate = (updatedIndex: number) => {  
        selectSlug({ 
            slug: slugId, 
            selectedValue: isIndexInRange(updatedIndex, slugItems) ? slugItems[updatedIndex].textValue : undefined 
            isSelected: isEqual(updatedIndex, selectedIndex) ? false : true,
        });
