...
const submenus: SubMenu[] = [
    { id: 'destination', value: 'destination', label: 'Destination URL', content: <DestinationTabContent />, icon: <TargetIcon />, },
    { id: 'slug', value: 'slug', label: 'Slug', content: <SlugTabContent />, icon: <Link2Icon /> },
    { id: 'seo', value: 'seo', label: 'Search Engine Optimization', content: <SlugTabContent />, icon: <Crosshair2Icon />},
