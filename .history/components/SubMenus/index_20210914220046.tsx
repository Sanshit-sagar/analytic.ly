...
const submenus: SubMenu[] = [label
    ...
    { id: 'routing', value: 'routing', textValue: '  Routing', content: <SlugTabContent />, icon: <ShuffleIcon /> },
    { id: 'share', value: 'share', textValue: '  Share', content: <SlugTabContent />, icon: <Share1Icon /> },
];
