...
const CategorizedUrchins = ({ urchins, userInput }: { urchins: any[]; userInput: string }) => {
    ...
    return (
        <Flex css={{ display: 'flex', fd: 'column', jc: 'flex-start', ai: 'stretch', gap: '$1' }}>
             <FilterResults category={} userInput={userInput} isReady={isReady} filteredUrchins={urchins}
...
const FilterResults = ({ category, isReady, filteredUrchins }: { category: string; isReady: boolean; filteredUrchins: })
