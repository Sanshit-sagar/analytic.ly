...
const password = () => {
    const exp = useAtomValue(expirationTimestmaps)
}
const fullUrlStr = () => `${destination()}${utmMedium()}${utmSource()}${utmContent()}${utmTerm()}${utmCampaign()}${expiration()}`
...
const Submit = () => {
    ...
    const handleSave = () => alert(`About to submit: ${submission}`)
