...
type SeoGroupEventType = 'focussed'
...
const seoGroups: SeoGroupConfig = {
    focussed: { atom: focussedParamAtom, colors: { on: 'green', off: 'transparent' }, icon: <CursorTextIcon /> },
    clicked:  { atom: clickedParamAtom, colors: { on: 'yellow', off: 'transparent' }, icon: <EyeOpenIcon /> },
    hovered:  { atom: hoveredParamAtom, colors: { on: 'orange', off: 'transparent' }, icon: <CursorArrowIcon /> },
}
