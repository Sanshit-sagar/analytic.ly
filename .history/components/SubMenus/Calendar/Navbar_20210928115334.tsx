...
const leftNavButtonStyles = { br: '$1',  margin: '$2', mt: '$2', height: '30px', width: '30px', float: 'left' }
const rightNavButtonStyles = { br: '$1',  margin: '$2', mt: '$2', height: '30px', width: '30px', float: 'right' }
