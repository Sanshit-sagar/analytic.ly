...
const mainMenuItems: ITabItem[] = [
    ...
    { id: 'timeframe', value: 'Expiration', textValue: ' Expiration', content: <ExpirationTabContent />, icon: <ClockIcon />},
    { id: 'security', value: 'Security', textValue: '  Security', content: <SecurityTabContent />, icon: <LockClosedIcon /> },
    { id: 'abtesting', value: 'A/B Testing', textValue: '  A/B Testing', content: <AbTestingTab />, icon: <PersonIcon /> },
]
