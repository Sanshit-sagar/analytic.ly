...
const slugCategoryAtom = atom<string>(slugCategoryOptions[0].textValue)
...
const SlugCategorySelector = () => {
    ...
    return (
        <SelectMenu
            ...
            selectedValue={slugCategories[slugCateogoryIndex].icon}
    ...
    const SelectionIndicator = ({ index }: { index: number }) => {
        if(index!==slugCateogoryIndex) return null;
