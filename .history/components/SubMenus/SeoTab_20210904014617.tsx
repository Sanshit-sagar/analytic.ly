...
export const utmMediumStrAtom = atom((get) => get(seoSourceAtom) ? `utm_source${get(seoSourceAtom)}` : '')
export const utmTermStrAtom = atom((get) => get(seoSourceAtom) ? `utm_source${get(seoSourceAtom)}` : '')
