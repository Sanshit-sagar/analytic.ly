    ...
    return (
        <Flex css={{  fd: 'column', jc: 'flex-start', ai: 'center', gap: '$1'}}>
            ...
            <Toolbar>            
                ...
                <ToolbarToggleGroup type='single' defaultValue='1'> 
                    {validSaltTypes.map((type, i) => {
                        return (
                            
                        )
                    })}
                    <ToolbarToggleItem value='1'> left </ToolbarToggleItem>
                    <ToolbarToggleItem value='2'> center </ToolbarToggleItem>
                    <ToolbarToggleItem value='3'> right </ToolbarToggleItem>
                </ToolbarToggleGroup>
             </Toolbar>   
