...
const OPEN_GRAPH_API_KEY = '40815603-3327-4223-b489-e98da949f5d4'
...
const OpenGraphPreview = ({ destinationInput, isDestValid }: IOpenGraphPreviewProps) => {

    return (
        <OpengraphReactComponent  
          site={'site that you want to load (url encoding is done for you)'}  
          appId={OPEN_GRAPH_API_KEY}  
          loader={<Loading isIndeterminate type='spinner' />}  
          size={'small'}    
        />
    )
}
