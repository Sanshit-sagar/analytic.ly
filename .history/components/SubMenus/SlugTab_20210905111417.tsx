...
const SaltTypeControlGroup = () => {
    const [saltType, setSaltType] = useAtom(saltTypeAtom)

    const updateSaltType = (value: string) => setSasetSaltTypeltAk 
    return (
        <ControlGroup>
            <Label>
                <Text size='1' css={{ color: '$text' }}> Salt Type </Text>
            </Label>
