...
const getYear = (date: Date): number => new Date(activePage).getFullYear(); 
        ...
        <>
            <Tooltip content={`${previousMonth.getMonth()}`}>
                <IconButton 
                    ...
                    onClick={() => {
                        ...
                        let updatedYear = updatedMonth==='December' ? getYear(activePage) - 1 : getYear(activePage) 
            ...
            <Tooltip content={`${nextMonth.getMonth()}`}>
                <IconButton
                    ...
                    variant='ghost'
                    onClick={() => {
                        let updatedMonth = nextMonth.getMonth()
                        let updatedYear = updatedMonth==='January' ? getYear(activePage) + 1 : getYear(activePage) 
                        setActivePage(new Date(updatedYear, updatedMonth, 1))
                        onPreviousClick()
                    }}
