...
function getMonthsInRange(fromMonth: Date, toMonth: Date, LOCA): IMonthItem[] {
...
const MonthSelector = ({ onChange, localeUtils }: IMonthSelectorProps) => {
    ...
    const monthItems: ICalendarItem[] = getMonthsInRange(fromMonth, toMonth, localeUtils);
...
function getYearsInRange(fromYear: Date, toYear: Date) {
