...
export const StyledExpirationTab = styled('div', {
    width: '100%',
    height: '100%',
    display: 'flex',
    flexDirection: 'row',
...
export const Calendar = () => {
    ...
    const [month, setMonth] = useAtom(fromMonthAtom)
    ...
    //     try {
    //         intervalStart = range[1]?.from ? new Date(parseInt(range[1].from)).getTime() : new Date().getT
