...
export const FmtDate = ({ fmtDate, type }: { fmtDate: string, type: string; }) => {
    return <FormattedDateText> {type}: {fmtDate} </FormattedDateText> 
}
...
const ToDateInput = () => {
    ...
    return <FmtDate fmtDate={sanitizeDate(enteredTo)}  type="START"/> 
}

const FromDateInput = () => { 
    const hoveredStartDate = useAtomValue(hoveredStartDateAtom)
    return <FmtDate fmtDate={sanitizeDate(hoveredStartDate)}  type="END"/> 
}
