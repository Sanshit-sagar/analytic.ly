...
const NavButton = ({ id, className, handleClick }: { id: string; className: string; handleClick: (event: React.MouseEvent<HTMLButtonElement>; }) => (
    <IconButton
        id={id}
        size='2'
        variant='ghost'
...
const NavButton = ({ className, onClick, transform }: { 
    className: string; 
    onClick: () => void; 
    ...
    const navigateToPrevMonth = (event: React.MouseEvent<HTMLButtonElement>) => {
