...
const ToDateInput = () => {
    ...
    const [enteredTo, setEnteredTo] = useAtom<Date | undefined | null>(null)
...
const CustomCalendar = () => {
    ...
    const handleEnteredToChange = (updatedEnteredTo: Date) => {
        setEnteredTo(updatedEnteredTo)
        setStage(updatedEnteredTo)
    }
    const handleHoveredStartDateChange = (updatedStartDate: Date) => {
        setHoveredStartDate(updatedStartDate)
        setStage(updatedStartDate)
    }
...
//     return <Text size='2'> Current Stage: {stage} </Text>
// }
