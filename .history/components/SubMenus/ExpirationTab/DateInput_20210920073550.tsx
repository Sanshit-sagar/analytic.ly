...
function Segment({ children, ariaLabel, max }: ISegmentProps) {
            ...
            switch(e.inputType) {
                case 'insertText': 
                    setValue((value: string) => {
                        ...
                        if(e.data && numberParser.isValidPartialNumber(newValue)) {
                            ...
                            if(parsed * 10 > max && timeoutRef!==undefined) {
    ...
    let { spinButtonProps } = useSpinButton({
        value,
        onIncrement: () => setValue((value) => parseInt(`${value}`) + 1),
        onDecrement: () => setValue((value) => parseInt(`${value}`) - 1)
    });
...
export const CustomDateInput = () => {
    ...
    return (
        ...
        >
            ...
            <h1> hi </h1> 
            <FocusScope>
                <Segment ariaLabel='Month' max={12}>
                    12
                </Segment>
                -
                <Segment ariaLabel='Day' max={31}>
                    02
                </Segment>
                -
                <Segment ariaLabel='Year' max={2023}>
                    2021    
                </Segment> 
            </FocusScope>
        </DateInputContainer>
