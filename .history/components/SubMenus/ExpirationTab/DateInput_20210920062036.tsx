import React, { useMemo, useRef, useState, useLayoutEffect, useState } from 'react'
import { styled } from '../../../stitches.config'

import { FocusScope, FocusManager } from '@react-aria/focus'
...
function Segment({ children, "aria-label": ariaLabs, max }) {
    ...
    let { focusProps } = useFocusRing({ onFocusChange: setFocused })
