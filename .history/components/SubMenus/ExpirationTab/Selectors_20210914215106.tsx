...
const YearSelector = ({ onChange, fromMonth, toMonth }) => {
    ...
    return (
        <SelectMenu
            ...
            items={yearItems}
            selectedIndex={year}
            setSelectedIndex={(value: string) => handleYearChange(month, parseInt(`${value}`) + 2021)}
            selectedValue={year}
...
function YearMonthForm({ date, fromMonth, toMonth, localeUtils, onChange }: IYearMonthFormProps) {
