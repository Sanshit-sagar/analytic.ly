...
export const separatorAtom = atom((get) => separators[get(separatorIndexAtom)].separator)
export const saltTypeAtom = atom((get) => saltTypes[get(saltTypeIndexAtom)].category)
