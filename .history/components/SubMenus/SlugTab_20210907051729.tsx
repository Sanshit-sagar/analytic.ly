...
export const SALT_LENGTH_NAME = 'LENGTH OF LASTSUFFIX'
...
const SeperatorSelector = () => {
    ...
    const hash = (a: string, b: string): string => `${controlGroupName}-${a}-or-${b}`
    ...
    const formatContent = ({ textValue, value, alt, icon }: typeof {...separator}) => <> icon || textValue </>
