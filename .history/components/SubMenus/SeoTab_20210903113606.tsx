...
import { UrlFieldSet as FieldSet, FieldSetGroup, FieldSetGroupHeading, Label } from '../../primitives/FieldSet' 
        ...
        <Box css={{ width: '100%', height: '100%', margin: '$1', padding: '$1 $2' }}>
            ...
            <FieldSetGroup>
                {Object.entries(seo).map((seoEntry, i) => {
                    return (
                        <FieldSet css={{ width: '49%', padding: '$1', mb: '$1', bc: '$panel', border: 'thin solid transparent', br: '$2' }}> 
