...
const slugCategoryOptions = [
    { id: 0, category: 'Short', description: '', getter: any},
    { id: 1, category: 'Cute', description: '', getter: any},
    { id: 2, category: 'Secure', description: '', getter: any},
    { id: 3, category: 'Marketable', description: '', getter: any},
    { id: 4, category: 'Custom', description: '', getter: any}, 
];
            ...
            >
                <SelectTrigger>
                    <Flex css={{ width: '100%', fd: 'row', jc: 'space-between', ai: 'stretch', gap: '$3' }}>
                        {slugCategoryOptions[selectedSlugCategoryIndex].cateogry} 
                        <ChevronDownIcon />
                    </Flex>
                </SelectTrigger>
                <SelectContent>
