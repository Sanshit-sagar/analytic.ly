...
const slugCategoryOptions: ISelectMenuProps[] = [
    { textValue: 'Random', value: 'random', icon: <MixIcon />, description: '', alt: '', groupName: 'sep' },
    { textValue: 'Custom', value: 'custom', icon: <StarIcon />, description: '', alt: '' },
];

const separators: ISelectMenuProps[] = [
    { textValue: '-', value: 'hyphen', alt: 'dash', icon: <DashIcon />, description: '' },
    { textValue: '_', value: 'underscore', alt: undefined, icon: undefined, description: '' },
    { textValue: '*', value: 'star', alt: 'asterisk', icon: <StarIcon />, description: '' }, 
    { textValue: '.', value: 'dot', alt: 'period', icon: <DotIcon />, description: '' }
];
