...
const SeperatorSelect = () => {
    ...
    const SelectTrigggerWithIco = () => {
        if(!separators?.length || selectedIndex>separators.length) return <><ChevronDownIcon/><<Text> {separators[selectedIndex]?.symbol} <ChevronDownIcon /></Text>
    }
