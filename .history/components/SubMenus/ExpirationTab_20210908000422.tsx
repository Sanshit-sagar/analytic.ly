...
const slugTimeframeStartAtom = atom(
    ...
    (_get, set, update: React.SetStateAction<Date>) => {
...
export const ExpirationTabContent = () => {
    const [slugAliveAt, setSlugAliveAt] = useAtom(slugTimeframeStartAtom)


    const handleDayClick = (day) => {
        const updatedStart = DateUtils.addDayToRange(day, slugA)
    }
