...
const StartInput = () => {
    ...
    const handleDayChange = (updatedDay: Date, modifiers: DayModifiers, dayPickerInput: DayPickerInput) => {
        ...
        dispatch({ type: 'assign', payload: { key: 'start', value: updatedDay, message: value: isEmpty ? NO_INPUT_ERROR : !selectedDay ? INVALID_DAY_ERROR : isDisabled ? DISABLED_DAY_ERROR : '' }});
        dispatch({ 
