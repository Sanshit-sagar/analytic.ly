...
export const destinationInputAtom = (
    (get) => get(destinationAtom),
    (_get, set, update: React.SetStateAction<string>) => set(destinationAtom, update) 
);
export const isDestinationInputValidAtom = atom(
    (get) => get(destinationInputAtom).match(VALID_URL_REGEX) !== null
);
