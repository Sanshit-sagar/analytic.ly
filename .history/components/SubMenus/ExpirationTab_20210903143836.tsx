...
const slugLifetimeInputAtom = atom({ start: getDateAtTminus1min(), end: getDateAtTplus1min(), difference: 12000, errors: { errorStrs: undefined, selectionStr: undefined })
