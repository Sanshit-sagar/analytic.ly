...
const getMillisInXMins = (x: number): number => 1000*x;  
const getTMinus1Min = () => new Date().getTime() - getMillisInXMins(1)
const getTPlus1Min = () => new Date().getTime() + getMillisInXMins(1)

export const newSlugTimeframeStartAtom = atom<Date>(getTMinus1Min())
export const newSlugTimeframeEndAtom = atom<Date>(getTP
