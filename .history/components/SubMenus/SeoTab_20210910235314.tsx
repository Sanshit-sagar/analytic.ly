            ...
            <FlexCenterCenterRow>
                {seoParams.map((seoParam: ISeoParameter, index: number) => (
                    <Flex css={{ fd: 'column', jc: 'center', ai: 'stretch', gap: '$1' }}>
                        ...
                        <CategorizedUrchins urchins={categorizedUrchins[seoParam.id].filter((urchin) => urchin.startsWith(seoParams[seoParam.id]))} />
                    </Flex>
                ))}
                {/* <CategorisedResults />  */}
            </FlexCenterCenterRow>
