...
import { ITabMenu, Tabs } from '../../compositions/Tabs'
...
const activeMenuPanelAtom = atom(submenus[0].id)

const TabulatedMenu = () => {
    const [activePanel, setActivePanel] = useAtom(activeMenuPanelAtom)

    const handleTabChange = (updatedTab: string) => setActivePanel(updatedPanel)
