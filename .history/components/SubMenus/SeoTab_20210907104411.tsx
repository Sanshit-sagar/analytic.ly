...
const EventIconsGroup = ({ seoGroup, seoParam }: { seoGroup: SeoGroupConfig; seoParam: ISeoParameter }) => {
    ...
    return (
        <Label>
            <FlexStartCenterRow>
                ...
                <FlexEndCenterRow>
                    {Object.entries(seoGroups).map((seoGroupConfigEntry: [string, SeoGroupEventConfig][], _: number) => (
                        <EventIconsGroup 
                            seoGroup={seoGroupConfigEntry[1]}
                            seoParam={seoParam}
                        />
                    ))}
                </FlexEndCenterRow>
