...
export const focussedAtom = atom((get) => [get(seoMediumAtom), get(seoTermAtom), get(seoSourceAtom), get(seoCampaignAtom), get(seoCampaignAtom)]);
export const focussedParamAtom = atom(
    (get) => get(focussedAtom),
    (_get, set, update: React.SetStateAction<string[]>) => set(focussedAtom, [...focussedAtom, update]); 
)

export const utmAtom = atom('')
export const utmStrAtom = useAtom(
    (get) => get(utmAtom),
    (get, set, update: React.SetStateAction<string>) => set(utmAtom, )
)
                    ...
                    > 
                        ...
                        <FieldSetInputGroup>
                            ...
                            <Button 
                                ...
                                css={{ bc: 'transparent', border: 'none', padding: '$1 $2', color: '$text' }}
                            >
                                <CaretDownIcon />
                            </Button>
                        </FieldSetInputGroup>
