...
const SeperatorSelect = () => {
    ...
    const updateSeparatorIndex = (index: number) => setSeparatorIndex(index);
    ...
    const SelectTrigggerWithIcon = ({ index }: { index: number }) => {
        const selectableText = isValidIndex(i, separators) ? separators[index]?.symbol : ''
        return (
