...
import { NewSlugDetailsSummary } from './Summary'
...
const submenus: SubMenu[] = [
    ...
    { id: 'security', value: 'security', label: '  Security', content: <SecurityTab />, icon: <LockClosedIcon /> },
...
const TabulatedMenu = () => {
    ...
    return (
        <Dialog>
            ...
            <DialogContent>
                <DialogTitle> New Slug </DialogTitle>
