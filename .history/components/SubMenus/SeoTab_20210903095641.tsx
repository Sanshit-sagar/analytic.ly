...
const SeoTabContent = () => {
    ...
    return (
        <Box css={{ width: '100%', height: '100%', margin: '$1', padding: '$1 $2' }}>
            ...
            <Flex css={{ margin: '$2', fd: 'row', jc: 'space-between', ai: 'flex-start', gap: '$1', flexWrap: 'wrap' }}>
                {Object.entries(seo).map((seoEntry, i) => {
                    return (
                        <FieldSet css={{ width: '45%', padding: '$2', mb: '$2', bc: '$canvas', border: 'thin solid transparent', br: '$2' }}> 
                            <Label>
                                {titles[seoEntry[0]]} 
                            </Label>
