...
interface DestinationURLObject { hostname: string; hash: string; origin: string; password: string; protocol: string; port: string; search: string; username: string; pathname: string; } | null
