...
const seoGroups = {
    'focussed': { atom: focussedParamAtom, on: 'green', noMatchColor: 'transparent', icon: <CursorTextIcon /> },
    'clicked':  { atom: clickedParamAtom, matchColor: 'yellow', noMatchColor: 'transparent', icon: <EyeOpenIcon /> },
    'hovered':  { atom: hoveredParamAtom, matchColor:  }
}
