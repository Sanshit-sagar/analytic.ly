...
const generateKeyFromValue = (controlGroupName: string, a) => `${controlGroupName}-${hashAB(a,b)}`
const generateKeyFromIndex = ()
...
const SeperatorSelector = () => {
    ...
    const hash = (a?: string, b?: string, i: number): string => {
        a && b ? generateKey(controlGroupName, a, b) : `${controlGroupName}-${hashI(i)}`;
    };
