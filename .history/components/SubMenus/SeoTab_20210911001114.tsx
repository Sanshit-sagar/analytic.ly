    ...
    return (
        <Flex css={{ display: 'flex', fd: 'column', jc: 'flex-start', ai: 'stretch', gap: '$1' }}>
             <FilterResults 
                ...
                userInput={userInput} 
                isReady={isReady} 
                filteredUrchins={urchins}
            />
            {urchins.map((urchin: string) =>  (
...
interface IFilterResultsProps { category: string; userInput: string | undefined; isReady: boolean; filteredUrchins: any[] | any | undefined | null }

const FilterResults = ({ category, userInput, isReady, filteredUrchins }: IFilterResultsProps) => {
