...
export const utmMediumStrAtom = atom((get) => get(seoMediumAtom) ? `utm_medium${get(seoMediumAt)}utm_source${get(seoSourceAtom)}` : '')
export const utmTermStrAtom = atom((get) => get(seoMediumAtom) ? `utm_source${get(seoSourceAtom)}` : '')
