...
const DateInput = ({ key }: IDateInput) => {
    ...
    const getFmtSelection = (sd: Date) => `You chose: ${updatedDay.toLocaleDateString()}`
    ...
    const handleDayChange = (updatedDay: Date, modifiers: DayModifiers, dayPickerInput: DayPickerInput) => {
        ...
        const messageStr = isValidInput ? getFmtSelection(selectedDay) : getError(isEmpty, selectedDay, isDisabled)
