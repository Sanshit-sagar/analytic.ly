...
import { atom, useAtom, WriteableAtom } from 'jotai'
...
interface SeoGroupEventConfig {
    ...
    atom: WriteableAtom<string, React.SetStateAction<string>>;
...
interface SeoGroupConfig {
    ...
    hovererd: SeoGroupEventConfig;
}

const seoGroups: SeoGroupConfig = {
    focussed: { eventType: 'focussed', atom: focussedParamAtom, colors: { on: 'green', off: 'transparent' }, icon: <CursorTextIcon /> },
    clicked:  {  eventType: 'clicked', atom: clickedParamAtom, colors: { on: 'yellow', off: 'transparent' }, icon: <EyeOpenIcon /> },
    hovered:  {  eventType: 'hovered', atom: hoveredParamAtom, colors: { on: 'orange', off: 'transparent' }, icon: <CursorArrowIcon /> },
}
