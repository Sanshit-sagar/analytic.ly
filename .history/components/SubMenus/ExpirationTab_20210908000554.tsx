...
const slugTimeframeAtomAtom= atom(
    (get) => get(slugTimeframeAtom),
    (_get, set, update: React.SetStateAction<{from: Date | undefined, to: Date | undefined}>) => {
...
export const ExpirationTabContent = () => {
    const [slugLifespan, setSlugLifespan] = useAtom(slugTimeframeStartAtom)
