...
interface IOpenGraphSummaryProps {
    destinationInput: string; 
    isDestValid: boolean; 
}

const API_KEY = 'e10d500c-1176-497a-ad22-899a99b57624	'
...
const useOpenGraph = (isDestValid: boolean, destinationInput: string) => {
    
    const { data, error } = useSWR([isDestValid ? destinationInput : null], fetcher);
...
const OpenGraphSummary = ({ destinationInput, isDestValid }: IOpenGraphSummaryProps) => {
