...
type Stitches = StitchesComponentWithAutoCompleteForReactComponents
type RadioChangeEvent = React.ChangeEvent<Stitches<ExtendedPrimitive<MenuRadioItemPrimitive, 
"div">
