...
const DateInput = () => {
    const setExpiration = useAtom(timeframeEndAtom)
    const setValidation = useAtom(timeframeValidationAtom)
    ...
    return (
<Box css={{ margin: 'auto', display: 'flex', border: 'thin solid', borderColor: '$border', borderRadius: '$2', '&:hover': { } }}>
            <DayPickerInput 
                value={selectedDay} 
