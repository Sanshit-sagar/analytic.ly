...
const EventIconsGroup = ({ seoGroup, seoParam }: { seoGroup: SeoGroupEventConfig; seoParam: }) => {
        ...
        <Label css={{ color: '$text' }}> 
            <Flex css={{  fd: 'row', jc: 'flex-start', ai: 'center', gap: '$1' }}>
                ...
                <Flex css={{ fd: 'row', jc: 'flex-end', ai: 'center', gap: '$1'}}>
                    {Object.keys(seoGroups).map((seoGroup: SeoGroupEventConfig, _: number) => {
                        <EventIconsGroup seoGroup={seoGroup} seoParam={seoParam} />
                    })}
                </Flex>
            </Flex>
        </Label>
