...
export const SelectableCalendar = () => {
    ...
    const handleDayClick = (day) => {        setSelectedEndpoint(firstSelected ? 'to' : 'from')
...
export const ExpirationTabContent = () => {
    const rangeStart = useAtomValue(rangeStartAtom)
    const rangeEnd= useAtomValue(rangeEndAtom)
