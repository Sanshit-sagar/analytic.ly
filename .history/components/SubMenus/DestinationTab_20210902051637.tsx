...
export const DestinationTabContent = () => {
    ...
    return (
        ...
        <>     
            <UrlFieldSet 
                css={{  
                    border: 'thin solid', borderColor: isDestValid ? 'green' : 'red', width: '100%', 
                    fd: 'column', jc: 'flex-start', ai: 'stretch', margin: '5px'
                }}
            >
                <Label css={{ color: '$text' }}> 
                    <Text size='1' css={{ color: 'loContrast' }}>
                        Original URL Web Address 
                    </Text>
                </Label>
                <TextField 
                    size='1' 
