...
const ParamsList = ({ params, name, index }: IParamsList) => {
    ...
    return (
        <Box key={index} css={{ border: 'thin solid $text', br: '$2', padding: '$1', margin: '$1' }}>
...
// ADD: GET /api/seo/user/:email/[all, recent, top/[source, medoum, menuc]
...
const SeoParametersLibrary = () => {
    ...
    return (
        <Flex css={{ fd: 'column', jc: 'flex-start', ai: 'flex-start',  width: '100px', gap: '$1' , flexWrap: 'wrap'}}>
