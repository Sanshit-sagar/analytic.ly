...
const mainMenuItems: ITabItem[] = [
    { id: '0', value: 'Destination', name: 'A/B Testing',  content: <DestinationTabContent />, icon: <TargetIcon />, },
    { id: '1', value: 'Slug', name: 'A/B Testing', content: <SlugTabContent />, icon: <Link2Icon /> },
    { id: '2', value: 'SEO', name: 'A/B Testing',   displayName: 'SEO', content: <SeoTabContent />, icon: <Crosshair2Icon />},
    { id: '3', value: 'Expiration', name: 'A/B Testing',  content: <ExpirationTabContent />, icon: <ClockIcon />},
    { id: '4', value: 'Security', name: 'A/B Testing', content: <SecurityTabContent />, icon: <LockClosedIcon /> },
