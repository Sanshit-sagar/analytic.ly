...
const Controller = () => {
    ...
    return (
        <Flex css={{ height: '500px', width: '500px', fd: 'column', jc: 'space-between', ai: 'flex-end', border: '1px solid $border', '&:hover': { borderColor: '$border3'}  }}>
            <Flex css={{ fd: 'column', jc: 'space-between', ai: 'flex-end', gap: '$1' }}>
                <NumberField
                    label='Alternates'
                    value={groupCount}
