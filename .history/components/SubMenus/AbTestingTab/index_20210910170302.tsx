...
const Controller = () => {
    ...
    const [minValue, setMinValue] = React.useState<number | undefined>(0.01)
    const [maxValue, setMaxValue] = React.useState<number | undefined>(1.00)
    const [stepSize, setStepSize] = React.useState<number | undefined>(Math.round(((maxValue - minValue)*100)/(alternateCount))/100)
    const [values, setValues] = React.useState<number[] | undefined>([])
