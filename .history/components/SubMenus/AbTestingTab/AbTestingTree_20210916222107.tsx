...
const List = () => {
    ...
    return (
        <Flex css={{ fd: 'column', jc: 'flex-start', ai: 'flex-start', gap: '$1', overflowY: 'scroll', height: '30em', width: '100%', border: '1px solid $border' }}>
    ...
    return (
        <Flex css={{ fd: 'row', jc: 'center', ai: 'stretch', gap: '$1'}}>
            <Flex css={{ fd: 'row', jc: 'space-between', ai: 'stretch', gap: '$1' }}>
                <Flex css={{ fd: 'column', jc: 'flex-start', ai: 'stretch', width: "45%" }}>
                    <List />
                </Flex>
                <Flex css = {{fd: 'row', jc: 'space-evenly', ai: '' width: "45%", margin: "auto" }}>
                    <NameField />
                    <PrimaryValueField />
                    <SecondaryValueField />
                </Flex>
