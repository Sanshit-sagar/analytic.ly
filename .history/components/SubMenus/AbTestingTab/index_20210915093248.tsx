...
function Number({ value }: { value: number }) {
    ...
    return (
        <animated.div 
            style={{ color: colors.funkyText, fontSize: 24, fontWeight: 'light', fontStyle: 'italics', boxShadow: `10px 0px 14px ${colors.funky}` }}
        >
...
const AbPercentages = () => {
    ...
    return (
        <Flex css={{ fd: 'row', jc: 'space-evenly', ai: 'center', gap: '$3' }}>
            {percentagesByGroup.map((pctByGroup: number) => (
