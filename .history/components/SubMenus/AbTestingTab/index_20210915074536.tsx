...
export const abTestGroupsAtom: abTestGroup[] = atom([
...
export const setAbTestUrl = atom(
    null,
    (get, set, update: React.SetStateAction<IabTestGroup>) => {
        let indexOfEntry = update.i
        set(abTestGroupsAtom, {
            ...get(abTestGroupsAtom),
            {
                id: update.id,
                url: update.url || undefined,
                percentage: update.percentage * 100,
            }
        }); 
    }
)
