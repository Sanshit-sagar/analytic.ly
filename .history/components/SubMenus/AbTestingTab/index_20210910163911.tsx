...
const Controller = () => {
    const [alternateCount, setAlternateCount] = React.useState(1)
    ...
    React.useEffect(() => {
        ...
        temp[0] = stepSize
        for(let i = 1; i<=alternateCount; i++) temp[i] = temp[i-1] + stepSize

        setValues([...temp]); 
    }, [alternateCount, minValue, maxValue, values]);
