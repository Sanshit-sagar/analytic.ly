...
const abTestGroupDiversionPercentAtom = atom([])

const Controller = () => {
    const [abTestPercentages, setAbTestPercentages] = useAtom(abTestGroupDiversionPercentAtom)
    ...
    const handleAlternateCountChange = (updatedAltCount: number) => {
        ...
        setAbTestPercentages([...handleInitValues(updatedAltCount, stepSize)])
    }
