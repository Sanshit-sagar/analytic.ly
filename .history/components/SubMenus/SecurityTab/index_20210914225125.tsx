...
export const SecurityTabContent = () => {
    ...
    const decreaseTenPct = () => setMeterValue(meterValue >= 10 ? meterValue - 10 : meterValue)
    const increaseBy = (amt: number) => setMeterValue(meterValue <= (100-amt) ? meterValue + amt : 100)
    const decreaseBy = (amt: number) => setMeterValue(meterValue >= amt ? meterValue - amt : meterValue)
