...
import { Toolbar, ToolbarSeparator, ToolbarLink } from '../../primitives/Toolbar'
...
export const SubmissionUrl = () => {
    ...
    const handleChange = () => {
        if(fullUrl.length > 75) setValue(fullUrl.substring(fullUrl.length - 75))
