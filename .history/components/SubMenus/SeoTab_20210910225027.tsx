...
const CategorisedResults = () => {
    ...
    const categoriezedUrchins = data.userUrchins
    const categories = Object.keys(categoriezedUrchins)
            ...
            {categories.map((category, i) => {
                return (
                    <Flex css={{ height: '100%', width: '100%', fd: 'column', jc: 'flex-start', ai: 'flex-start', gap: '$1' }}>
                        <Text size='1'>
                            {category}: {categorizedUrchins[category].length} matches
                        </Text> 
                        <br /> 
...
const SeoParamsCacbe = () => {
    ...
    // const utmCategories = !loading && !error && data ? Object.keys(data.userUrchins) : []
