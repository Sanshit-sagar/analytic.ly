    ...
    return (
        <Box 
            css={{ 
                ...
                fd: 'column',jc: 'flex-start', ai: 'stretch', gap: '1', bc: '$text'
            }}
        >
            <Text size='2' css={{ color: '$accent', textDecoration: 'underline', textDecorationColor: '$accent', fontWeight: 500 }}> 
                {focussed} 
            </Text>
            <Text size='2' css={{ color: '$accent', fontWeight: 500 }}>
