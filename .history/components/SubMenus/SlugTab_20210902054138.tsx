...
const SlugTabContent = () => {
    ...
    return (
        <>
            <Url FieldSet css={{ width: '100%', fd: 'column', jc: 'flex-start', ai: 'stretch'}}>
                <Labelsize='1' css={{ color: '$text' }}></UrlFieldSet>
                ...
                <NumStringsInput 
                    ...
                    setNumState={(event: EnvProps) => setNumStrings.map(nightStr) => {
                        setNumState('                 ')
                    }} />
                <SaltLengthInput 
                    saltLength={saltLength} 
                    setSaltLength={(setSaltLength: EnvProps)) => setSaltLength} 
                />
