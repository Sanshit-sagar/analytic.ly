...
const ExpandableUtmParameters  = ({ userUtmData, ...props }: { IntrinsicAttributes && userUtmData: UserUtmDatum[] }) => {
    const focussed = useAtomValue(focussedParamAtom) 

    return (
        <Accordion type="multiple">
            {userUtms.map((userUtm: UserUtmDatum, index: number) => {
...
const UtmParameters = () => {
    ...
    return (
        <ExpandableUtmParameters userUtmDatum={userUtms} />
    );
}
