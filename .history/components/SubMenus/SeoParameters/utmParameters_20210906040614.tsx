...
const userUtms: UserUtms = [
    { utm: 'campaign': [ { name: 'word1' }, { name: 'word2' } ],
    { utm: 'term', [ { name: 'word3' }, { name: 'word4' } ],
    { utm: 'medium',[ { name: 'word5' }, { name: 'word7' }, { name: 'word6'} ],
    { utm: 'term', { name: 'word8' }, { name: 'word9' } ],
    { utm: 'term', { name: 'word10' }, { name: 'word1' } ]
];
