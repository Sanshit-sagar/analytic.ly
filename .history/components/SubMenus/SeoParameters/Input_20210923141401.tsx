...
type CategoryType = UrchinCategoryEnum.MEDIUM | UrchinCategoryEnum.SOURCE | UrchinCategoryEnum.TERM | UrchinCategoryEnum.CAMPAIGN | UrchinCategoryEnum.CONTENT
...
const hoveredTypeAtom = atom<HoverType>(false)
const hoveredParamAtom = atom<HoverType(undefined)
