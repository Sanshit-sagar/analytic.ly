...
import { PopoverVariantTypeEnum, PopoverVariantType } from '../../ComboBox'
...
interface IDestructuredCCWProps {
    datumAtom: PrimitiveAtom<WritableAtom, SetStateAction<string>>;  props: any 
}
...
const ComboBoxWrapper = (props: IComboBoxWrapperProps) => {
    const { datumAtom, ...ccwProps }: IDestructuredCCWProps = props;

    const [value, setValue] = useAtom(datumAtom)
