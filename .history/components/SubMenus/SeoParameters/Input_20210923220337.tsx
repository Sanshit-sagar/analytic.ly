...
export const UtmParamInput = ({ key, label, filterValue, setFilterValue, endpoint }: IUrchinListProps) => {
    ...
    return (
        <ComboBox
            ...
            isLoading={list.isLoading || list.loadingState==='loading' || list.loadingState==='loadingMore' || list.loadingState='' || service.status==='loading' || service.status=='init' ? true : false}
