...
const hoverColorAtom = atom(
    (get) => {
        return (
                get(hoveredTypeAtom)===HoverTypeEnum.START ? 'green' 
            :   get(hoveredTypeAtom)===HoverTypeEnum.END ? 'red' 
            :   get(hoveredTypeAtom)===HoverTypeEnum.CHANGE.NONE 'transparent' : 'yellow'
