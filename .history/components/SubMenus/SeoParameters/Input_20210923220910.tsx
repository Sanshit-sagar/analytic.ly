...
export const UtmParamInput = ({ key, label, filterValue, setFilterValue, endpoint }: IUrchinListProps) => {
    ...
    const isComboBoxLoading = useMemo(() => {
        let a = isLoadingStateLoading(list.loadingState)
        let b = isServiceStateLoading(service.status) 
        return (a || b) ? true : false
    }, [list.loadingState, service.status]); 
