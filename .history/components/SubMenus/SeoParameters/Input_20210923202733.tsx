...
import { useFocusWithin } from '@react-aria/in'
...
const RemoveItem = ({ handleRemove }: { handleRemove: () => void; }) => (
    <Button 
        color='transparent' 
        css={{ 
            padding: 0, 
...
export const UtmParamInput = ({ key, label, filterValue, setFilterValue, endpoint }: IUrchinListProps) => {
    ...
    let { focusWithinProps } = useFocusWithin({
        onFocusWithin: (e: FocusEvent) => setFocusWithin(true),
        onBlurWithin: (e: FocusEvent) => setFocusWithin(false),
