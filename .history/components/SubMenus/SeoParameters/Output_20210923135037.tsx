...
const AttentionDetails = () => {
    const focussedParam = useAtomValue(focussedParamAtom)
    const hoveredParam = useAtomValue(hoveredParamAtom)
    const clickedParamAtom = useAtomValue(clickedParamAtomAtom)

    return (
        <Text> {JSON.stringify(focussedParam)} {JSON.stringify(hoveredParamAtom)} {JSON.stringify(clickedParamAtom)} </Text>
    )
}
