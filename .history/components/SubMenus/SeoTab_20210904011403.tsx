        ...
        <FieldSetGroup>
            {seoParams.map((seoParam, i) => {
                return (
                    <FieldSet 
                        key={i} 
                        css={{ width: '40%', p: '$1', mb: '$1', bc: '$panel', border: 'thin solid transparent', br: '$2' }}
                    > 
                        <Label css={{  color: '$text', textTransform: 'uppercase' }}>
                            {seoParam.id} 
                        </Label>

                        <Flex css={{ width: '100%', fd: 'row', jc: 'space-between', ai: 'flex-end', gap: '$1',  mt: '$2',
 border: '1px solid', borderColor: '$border',  backgroundColor: '$lightPanel', color: '$text', '&:hover': { borderColor: '$hiContrast', br: '$2' } }}> 
                            <TextField
                                size='1'
                                type='text'
                                ...
                                css={{ border: 'none' }}
                            />
                            <Button onClick={() => showPreviousInputs(seoParam.id)} css={{ bc: 'white', color: '$text' }}>
                                <CaretDownIcon />
                            </Button>
                        </Flex>
                    </FieldSet>
