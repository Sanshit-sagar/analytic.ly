...
export const SlugCategorySelector = () => {
    ...
    const selectedSlugCategory = useAtom(selectedSlugCategoryValueAtom)
...
export const SlugSelectionMenu = () => {
    ...
    return (
        <Text size='1'> {isOpen.toString()} | {selectedIdx} | {selectedVal} </Text>
    )
}
...
export const SlugTabContent = () => {
    ...
    return (
        <Flex css={{ width: '100%', fd: 'column', jc: 'flex-start', ai: 'stretch', gap: '$1'}}>
            <Text size='2'> Select a category that should be used to generate a Slug.</Text>
            <SlugSelectionMenu />
