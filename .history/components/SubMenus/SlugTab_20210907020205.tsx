...
type StitchesComponent = StitchesComponentWithAutoCompleteForReactComponents
type RadioChangeEvent = React.ChangeEvent<StitchesComponent<ExtendedPrimitive<MenuRadioItemPrimitive, "div">>>
