...
type DestinationObjectType = { [key: URLObjectKey]: URLObjectKey}

const UrlBreakdown = () => {
    const destinationParameters: DestinationURLObject | null = useAtomValue(destinatioParamsAtom)

    let keys: URLObjectKey[] = destinationParameters ? Object.keys(destinationParameters) : []
    ...
    return (
        ...
        >
            {destinationParameters && keys.map((key: URLObjectKey, idx: number) => {
