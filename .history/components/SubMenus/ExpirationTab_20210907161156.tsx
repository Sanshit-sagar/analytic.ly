...
const slugLifetimeAtom: PrimitiveAtom<{start: any | end} = atom({ start: null, end: null, hideOnDayClick: false, enteredTo: null })
...
const isStartSelected = atom((get) => typeof get(slugLifetimeStartAtom) ==='Date')
const isLifetimeEndSelectedAtom =  typeof get(slugLifetimeEndAtom) ==='Date')
const isSelectionBeforeStartAtom = atom((get) =>)
