...
const selectedDayIsBeforeFridayAtom = atom((get) => get(slugLifetimeStartAtom) && get(lastDayForMouseEnterAtom) && DateUtils.isDayBefore(get(lastDayForMouseEnterAtom), get(slugLifetimeStartAtom)))
