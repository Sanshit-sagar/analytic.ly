...
const separators: ISelectMenuProps[] = [
    ...
    { textValue: '_', value: 'underscore', alt: undefined, icon: undefined, description: '', groupName: 'category' },
    { textValue: '*', value: 'star', alt: 'asterisk', icon: <StarIcon />, description: '', groupName: 'category' }, 
    { textValue: '.', value: 'dot', alt: 'period', icon: <DotIcon />, description: '', groupName: 'category' }
];
