...
import { ToolbarIconButton } from '../../compositions/Icon'
...
const UndoRedo = () => {
    const handleUndo = (event: React.MouseEvent<HTMLButtonElement>) => console.log('Undoing')
    const handleRedo = (event: React.MouseEvent<HTMLButtonElement>) => console.log('Redoing')
