...
const ExpirationTabContent = () => {
    ...
    const [showWeekNumbers, setShowWeekNumbers] = useAtomValue(showWeekNumbersAtom)
    const [disableWeekends, setDisableWeekends] = useAtomValue(disableWeekendsAtom)
    const [showOutsideNumbers, setShowOutsideNumbers] = useAtomValue(showOutsideNumbersAtom)
