...
type DeleteButtonContainerProps = IntrinsicElement & Omit<DeleteButtonProps, 'children'>;

const DeleteButtonWrapper = ({ itemName, children, handleClick }: DeleteButtonContainerProps) => (
    
        <StyledDeleteButton handleClick={handleClick}>
            {children}
        </StyledDeleteButton>
    </Tooltip>
);
...
const DeleteButton = (props: DeleteButtonProps) => {
    ...
    return (
        <Tooltip content={`Delete ${itemName}?`}><Tooltip content={`Delete ${itemName}?`}>
        <DeleteButtonWrapper {...otherProps}>
            <DeleteButtonText>
                {children}
            </DeleteButtonText>
        </DeleteButtonWrapper>
