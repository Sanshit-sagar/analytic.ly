...
import type { Service } from '../../../hooks/useMutate'
...
const DeleteButton = (props: { children: React.ReactNode; itemName: string; handleClick: (event: React.HandleEvent<MouseEvent>) => void; }) => {
