...
export const UtmParamInput = ({ key, label, filterValue, setFilterValue, endpoint }: IUrchinListProps) => {
    ...
    const isLoadingStateLoading = (ls: string) =>  (ls===LoadingState.LOADING || ls===LoadingState.LOADING_MORE || ls===LoadingState.FILTERING || ls===LoadingState.SORTING) ? return true;
        return false; 
    };
