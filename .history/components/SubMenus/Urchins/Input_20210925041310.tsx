...
export function SeoParamsInput(props: ListBoxProps) {
...
function state(props: ListBoxProps, state: any, listBoxRef: React.RefObject<HTMLUListElement>): { listBoxProps: any } {
