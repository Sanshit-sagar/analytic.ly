...
import { HoverType, CategoryType } from '../interfaces'
...
function mapIdToParameter(id: string | undefined): CategoryType {
    if(!id) r
    let map =[
...
const writeHoverEventAtom = atom(
    ...
    (_get, set, updateEvent: FocusEvent) => {
        set(hoverDetailsGroupAtom, { 
            ...
            hoveredParameter: mapIdToParameter(updateEvent?.target?.id || undefined) 
        })
    }
)
