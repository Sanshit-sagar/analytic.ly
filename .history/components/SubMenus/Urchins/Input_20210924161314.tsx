...
type DeleteButtonContainerProps = IntrinsicElement & { children: React.ReactNode; handleClick: (event: MouseEvent) => void; 
}; 

const DeleteButtonContainer = ({ children, handleClick }: DeleteButtonContainerProps) => (
...
const DeleteButton = ({ 
    ...
    <DeleteButtonWrapper handleClick={handleClick}>
        <DeleteButtonText>
            {children}
        </DeleteButtonText>
    </DeleteButtonWrapper>
