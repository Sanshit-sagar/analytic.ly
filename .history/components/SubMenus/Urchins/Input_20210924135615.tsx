...
export const UtmParamInput = ({ key, label, filterValue, setFilterValue, endpoint }: IUrchinListProps) => {
    ...
    const isLoadingStateLoading = (ls: Loadig) => (ls===LoadingStateEnum.LOADING || ls===LoadingStateEnum.LOADING_MORE || ls===LoadingStateEnum.FILTERING || ls===LoadingStateEnum.SORTING) 
