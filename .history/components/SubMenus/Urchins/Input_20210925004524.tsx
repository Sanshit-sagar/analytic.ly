...
const urchinAtoms: UrchinAtom[] = [
    { key: 'medium', category: UrchinCategoryEnum.MEDIUM, atom: seoMediumAtom },
    { key: 'term', category: UrchinCategoryEnum.TERM, atom: seoTermAtom },
    { key: 'seo_categor', category: UrchinCategoryEnum.SOURCE, atom: seoSourceAtom },
