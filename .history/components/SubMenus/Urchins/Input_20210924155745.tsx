...
const DeleteButtonContainer = ({ children, handleClick }: { children: React.ReactNode; handleClick: (event: MouseEvent) => void; }) => (
    <button 
        onClick={handleClick} 
...
const DeleteButton = ({ 
    ...
    <Tooltip content={`Delete ${itemName}?`}>
        <DeleteButtonContainer handleClick={handleClick}>
            <DeleteButtonText>
                {children}
            </DeleteButtonText>
