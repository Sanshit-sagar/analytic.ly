...
const INIT_SLUG_LIFETIME = {  start: undefined,end: undefined, difference: undefined, errors: undefined}
...
const slugLifetimeReducerAtom = atom(INIT_SLUG_LIFETIME, reducer);
