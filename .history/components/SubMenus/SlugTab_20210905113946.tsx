...
const SeparatorSelector = () => {
    const separators = [
        ...
        { symbol: '_', value: 'underscore', alt: 'floor-dash' },
    ...
    return (
        <ControlGroup> 
            ...
            <ToolbarToggleGroup type="single" aria-label='Separator-bw-slug-fragments'>
                {separators.map((symbol: string, idx: number) => {
                    return (
                        <ToolbarToggleItem 
                            key={`Separator-id-${idx}`}
                            value={separator.value}
                            aria-label={`Separator-symbol-${separator.label}`}
                        >
                           <Text size='1'>
                               {separaor.symbol}
                            </Text>
