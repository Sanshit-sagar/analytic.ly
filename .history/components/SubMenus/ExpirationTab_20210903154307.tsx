...
const StartInput = () => {
    ...
    const handleDayChange = (updatedDay: Date, modifiers: DayModifiers, dayPickerInput: DayPickerInput) => {
        ...
        if(!isEmpty && !isDisabled && updatedDay) {
            ...
            messageStr = `{SELECTION_STR_PREFIX}: ${selectedDay.toLocaleDateString()}` 
        } else {
            setSelectedDay(undefined)
            messageStr = isEmpty ? NO_INPUT_ERROR :  !selectedDay ?  INVALID_DAY_ERROR : isDisabled ? DISABLED_DAY_ERROR : undefined
