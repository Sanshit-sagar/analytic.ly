...
const Options = () => {
    ...
    const options = [
        { id: 'weeks', value: showWeeks, handleToggle: () => setDisabledWeekends(!disabledWeekends) },
        { id: 'outsides', value: showOutsides, handleToggle: () => setDisabledWeekends(!disabledWeekends) },
