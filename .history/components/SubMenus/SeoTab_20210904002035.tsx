...
export const focussedAtom = atom(undefined)
export const focussedParamAtom = atom(
    (get) => get(focussedAtom),
    (_get, set, update: WritableAtom<string, React.SetStateAction<string>> | undefined) => set(focussedAtom, update) 
)
        ...
        <FieldSetGroup>
            {seoParams.map((seoParam, i) => {
                return (
                    <FieldSet 
                        key={i} 
                        css={{ width: '45%', p: '$1', mb: '$1', bc: '$panel', border: 'thin solid transparent', br: '$2' }}
                    > 
