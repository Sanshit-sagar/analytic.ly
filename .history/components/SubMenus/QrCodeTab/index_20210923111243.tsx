...
type LoadingStatus = LoadingStatusEnum.LOADING | LoadingStatusEnum.LOADING | LoadingStatusEnum.LOADING | LoadingStatusEnum.LOADING | LoadingStatusEnum.LOADING | LoadingStatusEnum.LOADING
...
export const UrchinLists = ({ key, label, filterValue, setFilterValue, endpoint }: IUrchinListProps) => {
    ...
    const [status, setStatus] = useState<LoadingStatusType>(LoadingStatusEnum.IDLE)
