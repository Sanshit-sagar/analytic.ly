...
const useUserSession = () => {
    ...
    const { 
        ...
        username, 
        firstName, 
        lastName, fullName, primaryEmailAddressId, primaryEmailAddress, primaryPhoneNumberId, primaryPhoneNumber, profileImageUrl, data, publicMetadata, unsafeMetadata }
