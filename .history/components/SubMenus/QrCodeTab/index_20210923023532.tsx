...
const seoParams: { id: string; atom: WritableAtom<string, React.SetStateAction<string>>} = [
...
export const UrchinLists = () => {
    const { firstName, lastName, primaryEmailAddress } = useUserSession()

    let [url, setUrl] = useState(`api/urchins/user/${primaryEmailAddress}/medium`)
