...
const urchinAtoms: { id: string; atom: WritableAtom<string, React.SetStateAction<string>> }[] = [
    { value: 'medium', atom: seoMediumAtom },
    { value: 'term', atom: seoTermAtom },
    { value: 'source', atom: seoSourceAtom },
    { value: 'campaign', atom: seoCampaignAtom },
    { value: 'content', atom: seoContentAtom }
]
