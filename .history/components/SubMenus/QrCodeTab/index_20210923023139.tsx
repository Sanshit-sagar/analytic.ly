...
const useUserSession = () => {
    ...
    return { data, firstName, lastName, primaryEmailAddress, primaryPhoneNumber }
}
...
export const UrchinLists = () => {
    const { firstName, lastName, primaryEmailAddress, data } = useUserSession()
    ...
    return (
        ...
        > 
           {firstName} | {lastName} | {primaryEmailAddress.emailAddress} | {JSON.stringify(Object.keys(data))}
        </Text> 
