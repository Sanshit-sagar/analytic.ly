...
export const pages: IPage[] = [
    ...
    { id: 'timeserier', name: 'Timeserier', index: 1, route: '/menu', icon: <ClockIcon /> },
    { id: 'geomapper', name: 'Geomapper', index: 2, route: '/menu', icon: <GlobeIcon /> },
    { id: 'tabulator', name: 'Tabulator', index: 3, route: '/menu', icon: <TableIcon /> }
]
