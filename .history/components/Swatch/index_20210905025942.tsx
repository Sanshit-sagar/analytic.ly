...
const themeIds: string[] = themes.map((theme: ITheme, i: number) => theme.id)
...
const Swatch = () => {
    ...
    //'default-theme', 'theme1-light', 'theme1-dark', 'theme2-light', 'theme2-dark', 
    useEffect(() => {
        document.body.classList.remove('theme3-light', 'theme3-dark')
