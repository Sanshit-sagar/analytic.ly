...
const themes = [
    { id: 'default-theme', name: 'Default Theme', className: defaultTheme, icon:  },
    { id: 'theme1-light', name: 'Theme1 [Light]', className: theme1Light, icon:  },
    { id: 'theme1-dark', name: 'Theme1 [Dark]', className: theme1Dark, icon:  },
    { id: 'theme2-light', name: 'Theme2 [Light]', className: theme2Light, icon:  },
    { id: 'theme2-dark', name: 'Theme2 [Dark]', className: theme2Dark, icon:  },
    { id: 'theme3-light', name: 'Theme3 [Light]', className: theme3Light, icon:  },
    { id: 'theme3-dark', name: 'Theme3 [Dark]', className: theme3Dark, icon:  },
];
