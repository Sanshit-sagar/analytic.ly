...
const themes: ITheme[] = [
    ...
    {index: 1,  id: 'theme1-dark', name: 'Theme1 [Dark]', className: theme1Dark, icon:  <BlendingModeIcon />, color: 'purple'   },
    { index: 1, id: 'theme2-light', name: 'Theme2 [Light]', className: theme2Light, icon:  <BlendingModeIcon />, color: 'white'   },
    { index: 1, id: 'theme2-dark', name: 'Theme2 [Dark]', className: theme2Dark, icon:  <BlendingModeIcon />, color: 'pink'   },
    { index: 1, id: 'theme3-light', name: 'Theme3 [Light]', className: theme3Light, icon:  <BlendingModeIcon />, color: 'white' },
    { index: 1, id: 'theme3-dark', name: 'Theme3 [Dark]', className: theme3Dark, icon:  <BlendingModeIcon />, color: 'green' },
];

export const activeThemeIndexAtom = atom(0)
export const activeThemeAtom = atom(
    (get) => get(activeThemeIndexAtom),
    (_get, _set, update: React.SetStateAction<ITheme>) => set(activeThemeIndexAtom, update.)
