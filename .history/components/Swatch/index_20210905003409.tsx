...
export const activeThemeAtom = atom<ITheme>(
    (get) => get<ITheme>(activeThemeIndexAtom),
    (get, set, update: React.SetStateAction<ITheme>) => set(activeThemeIndexAtom, get<ITheme>(update).index),
);
