...
const themes = [
    ...
    { id: 'theme1-light', name: 'Theme2 [Dark]', className: theme2Dark },
    { id: 'theme1-dark', name: 'Theme2 [Dark]', className: theme2Dark },
    { id: 'theme2-light', name: 'Theme2 [Dark]', className: theme2Dark },
    { id: 'theme2-dark', name: 'Theme2 [Light]', className: theme2Light },
];
