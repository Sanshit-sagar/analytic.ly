...
const themes = [
    { id: 'default-theme', name: 'Theme2 [Dark]', className: defaultTheme },
    { id: 'theme1-light', name: 'Theme2 [Dark]', className: theme1Light },
    { id: 'theme1-dark', name: 'Theme2 [Dark]', className: theme1Dark },
