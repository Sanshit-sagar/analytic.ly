...
const Swatch = () => {
    const setActiveThemeIndex = useUpdateAtom<number>(activeThemeIndexAtom)
    const activeThemeIdStr = useAtomValue<string>(activeThemeIdAtom)
    
    const handleRetheme = (themeIndex: number) => {
        setActiveThemeIndex(themes[i].id)
    }
