...
const themes = [
    { id: 'default-theme', name: 'Default Theme', className: defaultTheme },
    { id: 'theme1-light', name: 'Theme1 [Light]', className: theme1Light },
    { id: 'theme1-dark', name: 'Theme1 [Dark]', className: theme1Dark },
    { id: 'theme2-light', name: 'Theme2 [Light]', className: theme2Light },
    { id: 'theme2-dark', name: 'Theme2 [Dark]', className: theme2Dark },
    { id: 'theme3-light', name: 'Theme3 [Light]', className: theme3Light },
    { id: 'theme3-dark', name: 'Theme3 [Dark]', className: theme3Dark },
];
...
const Swatch = () => {
    ...
    useEffect(() => {
        document.body.classList.remove('default-theme', 'theme1-light', 'theme1-dark', 'theme2-light', 'theme2-dark', 'theme3-light')
        document.body.classList.add(activeThemeClassName.className)
