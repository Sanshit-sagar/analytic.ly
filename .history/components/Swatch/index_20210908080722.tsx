...
const Thematicaikon = ({ key, theme, index }: IThematicaikonProps) => {
    ...
    const handleRetheme = (updatedThemeIndex: number) => {
        let i
        const darkIfLight =  updatedThemeIndex + 1
        const lightIfDark =  updatedThemeIndex - 1
        const shouldBeDarkButIsnt = isDark && updatedThemeIndex%2===1
        const shouldBeLightButIsnt = !isDark && updatedThemeIndex%2===0

        setActiveThemeIndex(shouldBeDarkButIsnt ? darkIfLight : lightIfDark
    }
