...
import { theme2Light, theme2Dark } from '../../stitches.config'
...
const themes = [
    { id: 'theme2-dark', name: 'Theme1 [Dark]', className: theme2Dark },
    { id: 'theme2-light', name: 'Theme1 [Light]', className: theme2Light },
];
...
const Swatch = () => {
    ...
    useEffect(() => {
        document.body.classList.remove('theme2-light', 'theme1-dark')
