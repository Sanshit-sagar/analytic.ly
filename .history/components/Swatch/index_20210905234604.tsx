...
export const themes: ITheme[] = [
    ...
    { index: 7, id: 'theme3-light', name: 'Theme4 [Light]', className: theme4Light, icon: <BlendingModeIcon />, color: 'white' },
    { index: 8, id: 'theme3-dark', name: 'Theme4 [Dark]', className: theme4Dark, icon:  <BlendingModeIcon />, color: 'blue' },
];
