...
const CustomMercator:React.FC<GeoMercatorProps> = ({ 
    ...
    const {tooltipOpen, tooltipTop, tooltipLeft,hideTooltip, showTooltip, tooltipData} = useTooltip<any>();
    ...
    return (
      <>
                ...
                onMouseMove={(event) => {
                  ...
                  showTooltip({
                    tooltipData: { 
                      ...
                      x: top,
                      y: left,
                      data: markers[`(${Math.round(coordinate.x), ${Math.round((coordinate.y))}}`],
                    }
                  })
                }}
                onMouseLeave={() => hideTooltip()}
        ...
        {tooltipOpen && tooltipLeft && tooltipRight && tooltipData && (
          <TooltipInPortal
            key={Math.random()}
            top={tooltipTop}
            left={tooltipLeft}
