      ...
      <>
                          ...
                          showTooltip({
                            tooltipData: { 
                              ...
                              data:{
                                ...
                                stats: loading ? null : geodata?.countryFreqs[feature.properties.name] || []
                              }
                            },
                            tooltipTop: top,
                            tooltipLeft: left
        ...
        {tooltipOpen && tooltipLeft &&  tooltipTop && tooltipData &&   (   
          <TooltipInPortal
            ...
            left={tooltipLeft}
          >
            <Box css={{ height: '200px', width: '250px', maxWidth: '250px',display: 'flex', }}>
              <Flex css={{ fd: 'column', jc: 'flex-start', ai: 'stretch', gap: '$1', mt: '$1' }}>
                {Object.entries(tooltipData.data).map((d: GeoDatum, i: number) => {
                    return(
