    ...
    <>
      ...
      {tooltipOpen && (
        ...
        >
         ...
         s={{ fd: 'column', jc: 'flex-start', ai: 'stretch', gap: '$1', mt: '$1' }}> */}
         t.entries(tooltipData.data).map((datum, i) => { */}
         n (          
         ex css={{ fd: 'row', jc: 'space-between', ai: 'flex-start'}}> 
...
const HeatedGeo = () => {
  const [mode, setMode] = useState<string>('more')
  const [fetchStats, setFetchStats] = useState<boolean>(true);
