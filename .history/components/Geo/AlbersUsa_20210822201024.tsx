...
export const background = 'rgba(50,50,50,1.0)'const sizeScale = scaleLinear<number>({ domain: [0, 600], range: [0.5, 8] })const initialTransform = {  scaleX: 1.27,  scaleY: 1.27,  translateX: -211.62,  translateY: 162.59,  skewX: 0,  skewY: 0}
