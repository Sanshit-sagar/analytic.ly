                          ...
                          showTooltip({
                            tooltipData: { 
                              ...
                              data:{
                                ...
                                stats: countryFreqs[feature.properties.name]
                              }
                            },
                            tooltipTop: top,
                            tooltipLeft: left
          ...
          >
            <Box css={{ height: '200px', width: '250px' }}>
              <Flex css={{ fd: 'column', jc: 'flex-start', ai: 'stretch', gap: '$1', mt: '$1' }}>
                {Object.entries(tooltipData.data).map((datum: GeoDa, i) => {
                    return(
...
const HeatedGeo = () => {
    ...
    const { geostats, statsLoading, statsError } = useGeodata(true, 'more');
    
    const { countryFreqs, cityFreqs, postalCodeFreqs, metroCodeFreqs } = geostats
