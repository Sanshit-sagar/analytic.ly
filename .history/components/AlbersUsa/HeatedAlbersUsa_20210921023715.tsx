    ...
    return (
        <div style={{ position: 'relative' }}>
            ...
            {tooltipOpen && tooltipData && (
                ...
                >
                    <TooltipWrapper>
                        <Heading size='1'> {tooltipData.name} </Heading>
                        <Text css={{ color: colors.text, textDecoration: 'underline', textDecoration: colors.text}}> Views </Text>
                        <Text size='1'> {tooltipData.value} </Text>
                    </TooltipWrapper>
                </TooltipInPortal>
            )}
    )
