...
const ClickHistory = ({ amount, range, interval }: ClickHistoryProps) => {
    ...
    const now: number = parseInt(new Date())
    ...
    const graphDetails: GraphDetails = {
        ...
        durationInMs: new Da.getTime() - start.getTime(),
        numIntervals: parseFloat((end.getTime() - start.getTime())/(interval)),
        tickSizeInMs: interval
    }
