...
const Brush = ({ loading, error, mappedData, details, Controls }: BrushChartProps) => {
    ...
    return (
        <Box ref={gridItemRef} css={{ br: '$2', backgroundColor: BACKGROUND, height: '550px', width: '1000px' }}>
            <PrimaryChart
                data={filteredData}
                details={details}
