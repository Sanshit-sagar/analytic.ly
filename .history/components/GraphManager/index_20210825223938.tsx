...
const DarkMode = ({ toggleTheme }) => {
    ...
    return (
        <ToolbarToggleGroup type='single' defaultValue={false}>
            <ToolbarToggleItem value='dark' onClick={toggleTheme}>
                Theme: 
            </ToolbarToggleItem>
        </ToolbarToggleGroup>
    )
...
const GraphManager = ({ toggleMode }) => {
    ...
    return (
        <MarketProvider>
            <GraphContainer> 
                <Controls toggleTheme={toggleMode} />    
