...
const GraphManager = () => {
    ...
    return (
        <DashboardDisplayBox>
            <VisxParentSizeWrapper> 
                <Controls />    
                <Text> {quantity} | {timeAgoInMs} | {tickSize} | {numIntervals} </Text>
                <ClicksData amount={quantity} range={timeAgoOptions[timeAgo].label} interval={tickSizeOptions[tickSize].label}
            </VisxParentSizeWrapper>
        </DashboardDisplayBox>
    );
}
