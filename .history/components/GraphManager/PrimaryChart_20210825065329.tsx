            ...
            <svg height={height} width={width}>
                ...
                {tooltipData && (
                    <div>
                          ...
                          >
                                <Box css={{ padding: '$1', height: '100px', width: '200px', br: '$1', bc: 'white'}}></Box>
                            
                                        {Object.entries(tooltipData.d).map((tdField: any) => {
                                            return (
                                                <Text size='1'>{tdField}</Text>
                                            );
                                        })}
                                  
                                    </li>
                                    <Text size='1'>
                                        Click Score: <b>{`${getFormatValue(tooltipData.d)}`}</b>
                                    </Text>
                                </ul>
                          </TooltipWithBounds>
                   </div>
