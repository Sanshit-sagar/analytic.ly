...
// const DarkMode = ({ toggleMode }) => {// //       // return (        // <ToolbarToggleGroup type='single' defaultValue={false}>            {/* <ToolbarToggleItem value='dark' onClick={toggleMode}> */}                {/* Theme: */}                {isDark ? '🔥' : '🌘'}              {/* </ToolbarToggleItem> */}        {/* </ToolbarToggleGroup> */}    // )// }
const Controls = ({ toggleMode }) => {
