...
const Brush = ({ loading, error, mappedData, details, height, width }: BrushChartProps) => {
    ...
    return (
        <Box ref={gridItemRef} css={{ br: '$2', backgroundColor: BACKGROUND, height: height, width: width }}>
            <PrimaryChart
                data={filteredData}
                details={details}
