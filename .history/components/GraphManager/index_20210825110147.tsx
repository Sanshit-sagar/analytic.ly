...
const ToggleGroup = () => {
        ...
        e   { id: '1d', label: 'Past 1 Day', value: '/1/day' },
        e   { id: '2d', label: 'Past 2 Days', value: '/2/day' },
        e   { id: '5d', label: 'Past 5 Days', value: '/5/day' },
        e   { id: '1w', label: 'Past 1 Week', value: '/1/week' },
        e   { id: '1m', label: 'Past 1 Month', value: '/1/month' },
        e   { id: '3m', label: 'Past 3 Months', value: '/3/month' },
        e   { id: '1y', label: 'Past 1 Year', value: '/1/year' },
        e;
        e
...
const GraphManager = () => {
    ...
    return (
        <DashboardDisplayBox>
            <VisxParentSizeWrapper> 
                <Controls />    
                <Text size='1' css={{ color: isValid ? 'green' : 'red' }}> 
