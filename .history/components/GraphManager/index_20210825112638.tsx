...
const ToggleGroup = () => {
    ...
    const presets = [
        ...
        { id: '2d', index: 0, label: 'Past 2 Days', value: '/2/day' },
        { id: '5d', index: 0, label: 'Past 5 Days', value: '/5/day' },
        { id: '1w', index: 0, label: 'Past 1 Week', value: '/1/week' },
        { id: '1m', index: 0, label: 'Past 1 Month', value: '/1/month' },
        { id: '3m', index: 0, label: 'Past 3 Months', value: '/3/month' },
        { id: '1y', index: 0, label: 'Past 1 Year', value: '/1/year' },
    ];
