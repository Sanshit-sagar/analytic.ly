...
export type PopoverVariantType = PopoverVariantTypeEnum.SMALL | PopoverVariantTypeEnum.MEDIUM | PopoverVariantTypeEnum.LARGE

interface ICustomComboBoxProps {
    key: string;
    index: number;
    label: string; 
    value: WritableAtom<string, SetStateAction<string>>; 
