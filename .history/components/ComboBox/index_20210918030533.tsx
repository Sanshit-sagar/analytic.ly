...
export const AriaComboBox = ({ key, label, datumAtom, index, initOptions }: ICustomComboBoxProps) => {
    ...
    let options: IItem[] = options?.length ? [...options.map((option: string, i: number) => { id: i, name: option }
    })] : []
