...
interface IUrchinComboBoxProps {
    ...
    utmCategory: string; 
    value: string;
    updateValue: React.SetStateAction<string>; 
    index: number;
    initOptions: string[];
}


const UrchinComboBox = ({ key, utmCategory, value, updateValue, index, initOptions }: IUrchinComboBoxProps) => {
    if(!key || !value || !utmCategory || !updateValue) return null; 
