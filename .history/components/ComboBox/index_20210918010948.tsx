...
import { ComboBoxProps } from '../../compositions/interfaces'
...
const ComboBoxWithAtom = ({ atom, comboBoxProps }: { WritableAtom<string, React.SetStateAction<string>>; comboBoxProps: ComboBoxProps<any> 
} = props
