...
const CComboBox = ({ key, label, value, updateValue, index, initOptions }: IUrchinComboBoxProps) => {
...
const ComboBoxWithAtom = (props: { typeof {...ComboBoxComposition}; atom: WritableAtom<string, React.SetStateAction<string>>) => {
