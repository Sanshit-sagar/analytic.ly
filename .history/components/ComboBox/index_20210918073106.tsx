...
const saveItemBuffer = atom<string | undefined>(undefined);
const setSaveItemBuffer = (
    (get) => {
        return !!get(saveItemBuffer)
    },
    (_get: any, set: (atom<string | undefined>, React.SetStateAction<string | undefined>), update: string) => {
