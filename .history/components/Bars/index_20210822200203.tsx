...
const CustomChart = ({  
    ...
    const visitorIps = (d: Datum) => uniques[slug(d)].rankings.map((ranking: SlugRanking, i: number) => ranking.slug)
    ...
    // con colorScale = scaleOrdinal<string, string>({
    //    omain: keys,
    //    ange: [
    //       'blue', 
    //       'green', 
...
const GroupedBars = ({ darkMode }: { darkMode: boolean }) => {
