...
const RankedBars = () => {
  return (
    <rect height={'350px'} width={'1500px'} rx={15} ry={15} fill={'yellow'}>
      <div style={{ height: '300px', display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'flex-start', flexWrap: 'nowrap'  }}>
        <RankedBar category={'ip'} backdrop={'one'}/> 
        <RankedBar category={'engine'} backdrop={'two'}/> 
        {/* <RankedBar category={'browser'} backdrop={'three'}/> 
        <RankedBar category={'os'} backdrop={'one'}/> 
        <RankedBar category={'httpProtocol'} backdrop={'two'}/> 
        <RankedBar category={'tlsVersion'} backdrop={'three'} /> 
        <RankedBar category={'country'} backdrop={'three'} />  */}
      </div>
    </rect>
  )
}
