        ...
        <DialogContent>
            <Text size="5" as="h6" css={{ fontWeight: 500, mb: '$3' }}>
             ...
             <Text size="3" as="p" css={{ lineHeight: '25px' }}>
               There are 5 variants to choose from. Use is for positive states. a link
               Traditional business literature won’t help you solve it- most of ff is
               focused on life after product/market fit, after the Trough of Sor
             </Text>
