...
import { ChevronLeftIcon, ChevronLeftIcon, RefreshIcon } from '@radix-ui/react-icons'
...
const PaginationButton = ({ id, loading, disabled, onClick, value, icon }: IPaginationButtonProps) => (
    <ToolbarToggleItem 
        key={id}
        disabled={disabled}
        onClick={onClick}
