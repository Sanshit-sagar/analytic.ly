...
export const slugHeaders = [
    { key: 'ID', key: 'id' },
    { key: 'Destination', key: 'createdAt', sortable: true, width: 100 },
    { key: 'URL', key: 'url', sortable: true, width: 100 },
    { key: 'Password', key: 'password', sortable: true, width: 100 },
    { key: 'Expiration', key: 'expiration', sortable: true, width: 100 },
];