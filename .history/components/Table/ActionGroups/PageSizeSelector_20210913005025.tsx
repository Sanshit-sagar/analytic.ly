...
const tablePageSizeValueAtom = atom(geSizeAtom = atom(
    pageSizes[get(tablePageSizeIndexAtom)].textValue,)
...
export const PageSizeSelector = () => {
    ...
    const [selectedIndex, setSelectedIndex] = useAtom(tablePageSizeIndexAtom)
    const setSelectedSize = useAtom(tablePageSizeAtom)
