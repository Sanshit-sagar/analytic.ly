...
export const tablePageSizeIndexAtom = atom<number>(2)
export const tablePageSizeValueAtom = atom((get) => pageSizes[get(tablePageSizeIndexAtom)].textValue)
export const setPageIndexAtom = atom(
    null,
