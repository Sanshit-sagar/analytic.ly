...
export const PageSizeSelector = () => {
    ...
    const [selectedIndex,setSelectedIndex ] = useAtomValue(pageSizeIndexAtom)
    const selectedValue = useAtomValue(pageSizeValueAtom)
    const  = useUpdateAtom(pageSizeIndexAtom)
