...
const tablePageSizeAtom = atom(
    (get) => pageSizes[get(tablePageSizeIndexAtom)].textValue,
...
export const PageSizeSelector = () => {
    ...
    const [selectedIndex, setSelectedIndex] = useAtom<number>(tablePageSizeIndexAtom)
    const [selectedSize, setSelectedSize] = useAtom<string>(tablePageSizeAtom)

    const updatePageSize = (updatedIndex: number) => {
        // setSelectedIndex(updatedIndex)
        // setSelectedSize(pageSizes[updatedIndex].textValue)
        setSelectedSize(updatedIndex);
    }
