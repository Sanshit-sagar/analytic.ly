...
const initTabulatedSlugs = [
    { 
        ...
        url: 'https://www.lmnop.com?utm_medium=medium&utm_source=source'
    }, 
    { 
        name: 'Slug2', 
        password: 'xyzz', 
        ...
        expiration: new Date(2022, 1, 1),
        destination: 'https://www.abcd.com', 
        url: 'https://www.abcd.com?utm_medium=medium&utm_source=source'
    },
    {   name: 'Slug3', 
        password: 'xyzz', 
        createdAt: new Date(), 
        expiration: new Date(2022, 1, 1),
        destination: 'https://www.abcd.com', 
        url: 'https://www.qrstuv.com?utm_medium=medium3&utm_source=source',
    }
]
