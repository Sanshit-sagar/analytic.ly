...
const paginationButtons = [
    ...
    { id: 'prev',loading: loading, disabled: loading || atEarliest, onClick: () => firstPage(), icon: <ChevronLeftIcon /> },
    { id: 'next',loading: loading, disabled: loading || atEarliest, onClick: () => firstPage(), icon: <ChevronLeftIcon /> },
    { id: 'last',loading: loading, disabled: loading || atEarliest, onClick: () => firstPage(), icon: <ChevronLeftIcon /> }
]
