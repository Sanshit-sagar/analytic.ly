...
import { DropdownMenuIcon, TrackNextIcon, DotsHorizontalIcon, ReloadIcon } from '@radix-ui/react-icons'
        ...
        <TableContainer>
            <TableControls aria-label='Table Controls'>
                <ControlButton onClick={list.loadMore}>
                    {list.isLoading ?  <DotsHorizontalIcon /> : <TrackNextIcon />}
                </ControlButton> 
                <ControlButton onClick={list.reload}>
                    {list.isLoading ? <DotsHorizontalIcon />  : <UpdateIcon />}
                </ControlButton>
                <SelectMenu
                    selectOnly={true}
                    group={'pageSizes'}
