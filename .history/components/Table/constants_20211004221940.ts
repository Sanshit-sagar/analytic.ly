...
export const slugHeaders = [
    ...
    { key: 'destination', name: 'Slug', sortable: true, width: 100 },
    { key: 'url', name: 'Slug', sortable: true, width: 100 },
    { key: 'password', name: 'Slug', sortable: true, width: 100 },
    { key: 'expiration', name: 'Slug', sortable: true, width: 100 },
]