...
export const TabulatedSlug = ({ slug }: TabulatedSlugProps) => {
    ...
    let rows = [
        ...
        {id: 2, name: 'Program Files', expiration: '4/7/2021', type: 'File folder'},
        {id: 3, name: 'bootmgr', expiration: '11/20/2010', type: 'System file'},
        {id: 4, name: 'log.txt', expiration: '1/18/2016', type: 'Text Document'}
    ];
