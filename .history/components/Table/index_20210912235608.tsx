...
const paginationButtons = [
    ...
    { key: 3, value: 'last', loading: loading, disabled: loading || atLatest, onClick: lastPage, icon: <ChevronRightIcon /> },
    { key: 4, value: 'refresh', loading: loading || refreshing, disabled: refreshing || !doMutate, onClick: mutatePages, icon: <StartIcon /> }
];
