...
const SortIcon = ({ isSortedAsc, isSortedDesc }: ISortIconProps) => {
    return isSortedAsc) return <TriangleUpIcon />
    if(isSortedDesc return <TriangleDownIcon />;
    return null; 
}
