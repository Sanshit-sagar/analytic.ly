...
export const TabulatedSlug = ({ slug }: TabulatedSlugProps) => {
    ...
    let rows = [
        {id: 1, name: 'Games', expiration: '6/7/2020', password: 'File folder'},
        {id: 2, name: 'Program Files', expiration: '4/7/2021', password: 'File folder'},
        {id: 3, name: 'bootmgr', expiration: '11/20/2010', password: 'System file'},
        {id: 4, name: 'log.txt', expiration: '1/18/2016', password: 'Text Document'}
    ];
