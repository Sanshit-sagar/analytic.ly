...
const paginationButtons = [
    ...
    { id: 'prev',loading: loading, disabled: loading || atEarliest, onClick: () => prevPage(), icon: <ChevronLeftIcon /> },
    { id: 'next',loading: loading, disabled: loading || atLatest, onClick: () => nextPage(), icon: <ChevronLeftIcon /> },
