...
const DataTableWrapper = ({ 
    ...
    let list = useAsyncList({
        ...
        async sort({items, sortDescriptor}: { items: any[] | undefined; sortDescriptor:  { column: string; direction: string; }) {
            return {
              items: items.sort((a: ISortableColumnProps, b: ISortableColumnProps) => {
