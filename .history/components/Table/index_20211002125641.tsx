...
import { SortDescriptor } from '../SubMenus/Urchins/types';
...
const Table: React.FC<{}> = (props: any) => {
    ...
    let list = useAsyncList({
        ...
        async sort({items, sortDescriptor}: { items: Row[]; sortDescriptor: SortDescriptor<Row>}) {
            return {
