...
const DataTable: React.FC<{}> = (props: any) => {
    ...
    let headers = [
        ...
        { key: 'slug', name: 'Slug', sortable: true, width: 20 },
        { key: 'destination', name: 'Destination', sortable: true, width: 20 },
        { key: 'timestamp', name: 'Timestamp', sortable: true, width: 20 }, 
        { key: 'clicks',  name: 'Clicks', sortable: true, width: 20 },
        { key: 'country',  name: 'Country', sortable: true, width: 20 },
        { key: 'location',  name: 'Location', sortable: true, width: 20 },
    ]
            ...
            >
                <TableHeader>
                    {headers.map((header, _index: number) => (
                        ...
                        >
                            <Text size='2' css={{ width: header.width, color: '$funky'}}>
                                {header.name} 
                            </Text>
                        </Column> 
                    ))}
