...
const DataTable = ({ columns, clicks, fetchData, loading, error,  pageCount: controlledPageCount }: ITable) => {


    if(!loading || !clicks) return <TableSkeleton /> 
