...
const Table: React.FC<{}> = (props: any) => {
    ...
    const pageSizes = [
        ...
        { id: '3', value: 20, textValue: '15 items',alt: undefined, icon: undefined },
        { id: '4', value: 25, textValue: '15 items',alt: undefined, icon: undefined },
        { id: '5', value: 15, textValue: '15 items', alt: undefined, icon: undefined },
        15, 20, 25, 50]
        ...
        <TableContainer>
            <TableControls aria-label='Table Controls'>
                ...
                <SelectMenu
                    ...
                    setSelectedValue={updatePageSize}
                    selectedTextValue={`${pageSize}`}
                /> 
            </TableControls>
