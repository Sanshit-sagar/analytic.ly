...
const DataTable: React.FC<{}> = (props: any) => {
    ...
    let headers = [
        ...
        { key: 'slug', name: 'Slug', sortable: true, width: 165 },
        ...
        { key: 'geodata',  name: 'Location', sortable: true, width: 100 },
        { key: 'ip',  name: 'Location', sortable: true, width: 100 },
        { key: 'browser',  name: 'Location', sortable: true, width: 100 },
        { key: 'engine',  name: 'Location', sortable: true, width: 100 },
        { key: 'os',  name: 'Location', sortable: true, width: 100 },
        { key: 'tlsVersion',  name: 'Location', sortable: true, width: 100 },
        { key: 'httpProtocol',  name: 'Location', sortable: true, width: 100 },
        { key: 'tlsCipher',  name: 'TLS Cipher', sortable: true, width: 100 },
    ]
