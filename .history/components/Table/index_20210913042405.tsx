...
const DataTableWrapper = ({ 
    ...
    const keys = ['slug', 'destination', 'timestamp', 'clicks', 'country', 'location', 'geodata', 
                'ip', 'browser', 'engine', 'os', 'tlsVersion', 'httpProtocol','tlsCipher', 'clientAcceptEncoding'
            ]

    return (
        <DataTable sortDescriptor={list.sortDescriptor} onSortChange={list.sort}>
