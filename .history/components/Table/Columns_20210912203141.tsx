...
import { useDateFormatter, DateFormatterOptions } from '@react-aria/i18n'
import { ICellProps, ITimestampCellProps } from './interfaces'

const df: DateFormatterOptions = { dateStyle: 'short', timeStyle: 'short' };

export const getColumns = () => {
    let formatter = useDateFormatter(df);
