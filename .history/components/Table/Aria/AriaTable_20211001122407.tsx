...
import { TableProps, TableStateProps, } from './interfaces'
...
export const Table = (props: TableProps<HTMLTableElement>) => {
    ...
    let state: TableState<object> = useTableState({ 
        ...props, 
...
TableCellProps, state: TableState<unknown>, ref: React.RefObject<HTMLElement>)
function TableCell({ cell, state }: { cell: TableCellProps<any>; state: TableState<unknown>}) {
    let ref: RefObject<HTMLTableCellElement> = useRef<HTMLTableCellElement>(null!);
