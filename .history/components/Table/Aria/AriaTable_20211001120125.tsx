import React, { useState, useRef, RefObject, ForwardedRef, RefObject } from 'react'
import {
    useTable, 
    useTableCell, 
...
const TableRowGroup = React.forwardRef((props: GridRowProps<HTMLElement>, ref: ForwardedRef<HTMLElement>)=> {
  let { type: Element, style, children }: { type: Element; style: IntrinsicAttributes; children: React.ReactNode; } = props
