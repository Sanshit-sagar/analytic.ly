...
import { TableCollection, TableStateProps } from '@react-types/table'
...
export const Table = (props: TableProps<HTMLTableElement>) => {
    ...
    let tableStateProps: TableStateProps<HTMLTableElement> = { ...props, selectionMode}
    let state: TableState<HTMLTableElement> = useTableState({ , ...props });
