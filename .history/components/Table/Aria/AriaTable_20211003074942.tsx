...
function getMutableString(text: string | undefined) {
    let newString = text || ''
    return newString; 
}
        ...
        >
            <Checkbox 
                ...
                value={
                    ...
                    :   typeof checkboxProps?.value?.substring(0,9)==='readonly' ? getMutableString(checkboxProps.value) 
                    :   checkboxProps.value ? checkboxProps.value : ''} 
