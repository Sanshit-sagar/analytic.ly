...
import { TableProps, TableStateProps, TableRowProps, } from './interfaces'



export const Table = (props: TableStateProps<HTMLTableElement>) => {
    let ref: RefObject<HTMLTableElement> = useRef<HTMLTableElement>(null!)
    let state: { props: TableStateProps; showSelectionCheckboxes: boolean; }  = useTableState({ 
        ...props, 
    ...
    let { collection }: TableCollection<HTMLTableElement> = state
