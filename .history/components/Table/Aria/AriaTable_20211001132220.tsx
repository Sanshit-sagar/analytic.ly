import React, { useState, useRef, RefObject, ForwardedRef } from 'react'
...
import { GridRowProps,TableRowProps } from '@react-aria/grid'

import { Text } from '../../../primitives/Text'
import { useGloballyConsistentColors } from '../../../hooks/useColors'
// import { TriangleUpIcon, TriangleDownIcon } from '@radix-ui/react-icons'

import { TableProps, SelectionCheckboxAria, SelectionCheckboxProps } from './interfaces'
...
export const Table = (props: TableProps<HTMLTableElement>) => {
    ...
    let state: TableState<HTMLTableElement> = useTableState({ ...props, showSelectionCheckboxes: props.selectionMode === 'multiple' })
    let ref: RefObject<HTMLTableElement> = useRef<HTMLTableElement>(null!)
   
    let bodyRef: RefObject<RefObject<HTMLElement>> = useRef<RefObject<HTMLElement>>(null!)
...
const TableCheckboxCell = ({ 
    ...
    cell: GridNode<SelectionCheckboxAria>; 
    state: TableState<HTMLTableElement>;
}) => {
    let ref: RefObject<SelectionCheckboxAria> = useRef<SelectionCheckboxAria>(null!)
    let { gridCellProps } = useTableCell({ node: cell }, state, ref)
