    ...
    return (
        ...
        >
            <Checkbox 
                ...
                value={typeof checkboxProps.value==='number' ? `${checkboxProps.value}` : typeof checkboxProps.startsWith('readOnly') ? getMutableString(checkboxProps.value) : checkboxProps.value : ''}
