...
export const Table = (props) => {
    let state: TableState = useTableState({ ...props, showSelectionCheckboxes: props.selectionMode === 'multiple' });
...
function TableColumnHeader({ column, state }: { props: ColumnHeaderProps, state: TableState<T>, ref: RefObject<HTMLElement>}) {
