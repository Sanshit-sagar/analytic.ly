import React, { useState, useRef, RefObject, ForwardedRef, ReactNode } from 'react'
...
import { TableProps, TableCellProps,  ColumnHeaderProps, ColumnHeaderAria } from './interfaces'

import { Node } from '@react-types/shared'
import { GridNode } from '@react-types/grid'
import { TableCollection } from '@react-types/table'

export const Table = (props: TableProps<HTMLTableElement>) => {
    
    // showSelectionCheckboxes === 'multiple'
    let tableSelectionMode = props.showSelectionCheckboxes==='multiple'
    let tableStateProps: TableStateProps<HTMLTableElement> = { ...props, children: undefined }
    let state: TableState<HTMLTableElement> = useTableState(tableStateProps)
...
const TableRowGroup = React.forwardRef((props: GridRowProps<HTMLElement>, ref: ForwardedRef<RefObject<HTMLElement>>)=> {
  let {  type, style, children, ...otherProps }: TableRowProps<HTMLElement> = props
...
function TableHeaderRow({ 
    ...
    item: Node<GridNode<HTMLTableElement>>; 
    state: TableState<GridNode<HTMLTableElement>>;
    children: React.ReactNode; 
} ) {
...
const TableRow = ({ 
    ...
    item: Node<Node<Node<any>>>; 
    state: TableState<Node<Node<any>>;
    children: React.ReactNode; 
}) => {
...
function TableSelectAllCell({column, state}: { column: GridNode<unknown>; state: TableSelectState; }) {
