...
import { TableProps, TableCellProps, } from './interfaces'

import { Node } from '@react-types/shared'
import { GridNode } from '@react-types/grid'


export const Table = (props: TableStateProps<HTMLTableElement>) => {
...
const TableRowGroup = React.forwardRef((props: GridRowProps<HTMLElement>, ref: ForwardedRef<RefObject<HTMLElement>>)=> {
  ...
  let { rowGroupProps }: GridRowGroupAria = useTableRowGroup()
...
const TableRow = ({ 
    ...
    item: GridRowProps<Node<any>>; 
    state: TableState<Node<any>>; 
    children: React.ReactNode; 
}) => {
