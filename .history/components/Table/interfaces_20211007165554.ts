import { ReactNode, HTMLAttributes, ReactElement, InputHTMLAttributes, InputHTMLAttributes } from 'react'
...
export type FocusModeType = 'row' | 'cell'
...
export type AriaLabelsType = ('aria-label' 
    | 'aria-controls' 
    | 'aria-labeledby'
    | 'aria-describedby' 
    | 'aria-details' 
...
// export function getNotNull<T, K extends keyof T>(item: string | null): string {
