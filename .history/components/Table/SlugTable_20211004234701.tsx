...
const initTabulatedSlugs = [
    { name: 'Slug1', 
    destination: 'https://www.abcd.com', createdAt: new Date(), url: 'https://www.abcd.com?utm_medium=medium&utm_source=source', password: 'xyzz', expiration: new Date(2022, 1, 1) }, 
    { name: 'Slug2' }, 
    { name: 'Slug3' }
]
