...
import { useSingleSelectListState } from '@react-stately/useListData'
...
export const TabulatedSlug = ({ data }: TabulatedSlugProps) => {
    ...
    const list: = useSingleSelectListState<SlugList>({
        initialItems: [{ name: 'Slug1' }, { name: 'Slug2' }],
        initialSelectedKeys: ['Slug1'],
