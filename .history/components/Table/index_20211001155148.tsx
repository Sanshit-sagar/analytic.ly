...
const DataTable: React.FC<{}> = (props: any) => {
    ...
    let headers = [
        { key: 'slug', name: 'Name', sortable: true  },
        { key: 'destination', name: 'Height', sortable: true  },
        { key: 'timestamp', name: 'Mass', sortable: true }, 
        { key: 'clicks',  name: 'Birth Year', sortable: true },
        key: 'country',  name: 'Birth Year', sortable: true },
        key: 'location',  name: 'Birth Year', sortable: true },
    ]
