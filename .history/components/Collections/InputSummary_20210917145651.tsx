...
const passwordValidAtom = atom((get) => `Password: ${get(isPasswordValidAtom)}`)
...
const PasswordResults = () => {
    const passwordResultsAtom = useAtomValue(passwordResultsAtom)
    return <Tree name={passwordResultsAtom} />
}
...
const SummaryTree = () => {
    ...
    const passwordValidAtom = useAtomValue(passwordValidAtom)
