...
import { Tree, ControlledTreeNodeWithInput as TreeNode, ITreeNode } from '../../compositions/Tree'
...
const SummaryTree = () => {
    ...
    const handleChange = (updatedValue: string) => setValue({ ...node, id: node.id, name: node.name, primaryValue: updatedValue })
