...
const tabItems: ITabItem[] = [
    { id: '1', value: 'clipboard', name: 'Clipboard', content: <InputSummaryPanel />, icon: <ClipboardIcon /> },
    { id: '2', value: 'templates', name: 'Templates', content: <OpenGraphResults />, icon: <ArchiveIcon /> },
