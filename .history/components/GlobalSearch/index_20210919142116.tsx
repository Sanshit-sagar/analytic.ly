...
const getUserData = () => {
    ...
    utmParameters.set(UtmParametersEnum.SOURCE, terms?.length ? [...terms] : []);
    utmParameters.set(UtmParametersEnum.SOURCE, campaigns?.length ? [...campaigns] : []);
    utmParameters.set(UtmParametersEnum.SOURCE, contents?.length ? [...contents] : []);
        },
        custom: {} 
    }
