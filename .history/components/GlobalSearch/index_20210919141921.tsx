...
const getUserData = () => {
    ...
    utmCategories.set('source', sources?.length ? [...sources] : [])
    utmCategories.set('medium', mediums?.length ? [...mediums] : []);
    utmCategories.set('term', terms?.length ? [...terms] : []);
    utmCategories.set('campaign', campaigns?.length ? [...campaigns] : []);
    utmCategories.set('content', contents?.length ? [...contents] : []);
        },
        custom: {} 
    }
