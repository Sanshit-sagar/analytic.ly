...
export const GlobalSearch = () => {
    ...
    return (
        <SearchAutocomplete
            label='Search' placeholder='Looking for something?' allowsCustomValue
        >
            {[...userUrlParameters?.keys()].map((category: UtmCategory, categoryIndex: number) => {
                let paramsForCategory = userUrlParameters.get(category).parameters
