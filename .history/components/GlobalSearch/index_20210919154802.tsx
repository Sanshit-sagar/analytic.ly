...
export const GlobalSearch = () => {
    const userUrlParameters = getUserData()
            ...
            {utmCategories.map((category: UtmCategory, categoryIndex: number) => {
                ...
                return (
                    <Section 
                        ...
                        title={category}
                    >
                        {urchins.map((param: Urchin, urchinIndex; number) => (
                            <Item key={urchinIndex} textValue={param.id}> 
                                <div>
                                    <Label> {param.id} </Label>
                                    <Description> 
                                        {param.category}: {param.slugs.length} </Description>  
                                </div>
                            </Item>
                        ))}
                    </Section>
