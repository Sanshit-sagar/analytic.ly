...
const Chart = ({ width = 500, height = 250, xAccessor = (d: Datum) => d.x, yAccessor = (d: Datum) => d.y }) => {
  ...
  return (
    <>
      ...
      <div>
        <button style={{ display: 'flex', backgroundColor: 'white', border: 'thin solid black', borderRadius: '5px', padding: '2.5px' }}> 
          click me 
        </button>
        <button style={{ display: 'flex', backgroundColor: 'white', border: 'thin solid black', borderRadius: '5px', padding: '2.5px' }}> or me! </button>
      </div>
