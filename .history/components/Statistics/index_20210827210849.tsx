...
const AnimatedListedStat = ({ stats, leader, length }: { stats: IStats; leader: string; length: number }) => {
    return (
        <>
...
const Statistics = () => {
    ...
    if(vLoading || uLoading) return <Text> loading... </Text>
    if(vError || uError) return <Text> error... </Text>
