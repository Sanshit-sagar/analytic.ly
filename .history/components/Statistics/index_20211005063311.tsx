...
const StatisticLabelIcon = styled(Flex, {
   width: '100%', 
   fd: 'row', 
   jc: 'flex-start', 
   ai: 'stretch', 
...
const CategoryText = ({ category }: { category: string }) => (
    <Text as='span' size='2' css={{ color: '$funky' }}>
        {category}
    </Text>
);
...
const Category = () => {
    return (
        <StatisticLabelIcon>
            <CategoryText> {statIcons[index]}  {name.toUpperCase()} 
            </CategoryText>
        </StatisticLabelIcon>
    )
}
