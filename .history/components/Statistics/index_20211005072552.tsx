...
export const CachedStatistics = () => {
    ...
    return (
        <Container>
            {freqs && Object.entries(freqs).map((key: string, value: INormalizedFreqProps[][], index: number) => {
                return value[1]).map((itemsForCategory: INormalizedFreqProps[], index: number) => {
