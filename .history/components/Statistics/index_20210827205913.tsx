...
const AnimatedNumericalStat = ({ index, name, value }: { index: number; name: string; value: number }) => {
...
const AnimatedListedStat = ({ index, name, leader, value }: { index: number; name: string; value: number; leader: string }) => {
    return (
        <>
...
const Statistics = () => {
    ...
    const { uniques, uLoading, uError } = useUserRankings('uniques', , true);
