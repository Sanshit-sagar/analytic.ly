    ...
    return (
        <>
            <Flex css={{ width: '300px', fd: 'column', jc: 'flex-start', ai: 'stretch', gap: '$1'}}>
                <Flex css={{ fd: 'row', jc: 'flex-start', ai: 'stretch', gap: '$2'}}></Flex>
                <Text as='span' size='2' css={{ color: '$funky', mr: '$2' }}> {statIcons[index]} </Text>
                <Text as='span' size='2' css={{ color: '$text' }}> {name} </Text>
