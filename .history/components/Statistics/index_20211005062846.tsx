...
const StatisticLabelIcon {
    css={{ width: '100%', fd: 'row', jc: 'flex-start', ai: 'stretch', gap: '$2'}}
}
...
const NumberOne = ({numberOneItem}: {numberOneItem: string}) => {
    return (
