            ...
            {hasSpaceForLabel && (
              <animated.g style={{ opacity: props.opacity }}>
                ...
                >
                  <Label
                    showAnchorLine
                    anchorLineStroke={'rgba(50,255,150,1.0)'}
                    showBackground={false}
                    title={getKey(arc)}
                    subtitle={`${arc.value.toFixed(1)}%`}
                    fontColor={ darkMode ? "rgba(250,255,200,1.0)" : 'rgba(0,0,0,1.0)' }
                    width={100}
                  ...
                  />
                  <Connector stroke={ !darkMode ? "rgba(255,255,255,1.0)" : 'rgba(0,0,0,1.0)'} />
                </Annotation>
              </animated.g>
            )}
          </g>
