...
const filterAtom = atom('httpProtocol')
const activeFreqsAtom: PrimitiveAtom<any[]> = atom((get) => freqsForCategoryAtom[get(filterAtom)])

const PieChart = () => {
    const [filter, setFilter] = useAtom('httpProtocol')
    const [activeFreqs, setActiveFreqs] = useAtom([]); 
