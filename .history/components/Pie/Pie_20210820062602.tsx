...
const defaultMargin = { top: 100, left: 100, bottom: 50, right: 50 };
...
function FreqPieChart({
  ...
  const innerWidth = 0.85*(width - margin.left - margin.right)
  const innerHeight = 0.85*(height - margin.top - margin.bottom)
