...
const PieController = ({ filter, updateFilter }: PieControllerProps) => {
  ...
  return (
        <Toolbar aria-label="Formatting options" css={{ height: 35, bc: 'red' }}>
            <ScrollArea css={{ backgroundColor: '$bronze100' }}> 
                <ToolbarToggleGroup type="single" aria-label="Text formatting" css={{ width: '100%', display: 'inline-flex', fd: 'row', jc: 'flex-end', bc: 'red' }}>
