...
function FreqPieChart({
  ...
  const name: (d: Datum) => string = (d: Datum) => d.title.length > 20 ? `${d.title.substring(0,15)}...` : d.title 
  ...
  return (
    <>
      <svg width={width} height={height} fill={'black'}>
        <LinearGradient from='rgba(255,255,255,1.0)' to='rgba(255,255,255,1.0)' id={`gradientFill`} />
        <rect
          rx={14}
          width={width}
          height={height}
