...
function checkValidity(tickSizeStr: string) {
...
const tickSizeOptions: SelectionOption[] = [
    { id: 0, label: 'second', checkValidity('second') },
    { id: 1, label: 'minute', checkValidity('second') },
    { id: 2, label: 'hour', checkValidity('second') },
    { id: 3, label: 'day', checkValidity('second') },
    { id: 4, label: 'week', checkValidity('second') },
    { id: 5, label: 'month', checkValidity('second') },
];
