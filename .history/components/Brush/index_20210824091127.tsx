...
const SelectMenu:React.FC<string> = ({ menuName, openAtom, selectedIndexAtom, selectedStrAto }: IntervalProps) => {
    const [selectOpen, setSelectOpen] = useAtom(selectOpenAtom)
    const [selectedIndex, setSelectedIndex] = useAtom(intervalAtom); 
    const [selectedIndexStr] = useAtom(intervalStrAtom); 
