...
const Timeseries = () => {    // const [timeAgo, setTimeAgo] = useAtom(timeAgoAtom)    // const [tickSize, setTickSize] = useAtom(tickSizeAtom)    // const [isInvalid] = useAtom(invalidTickSizeAtom)    // const isTickSizeDisabled = (index: number) => {
