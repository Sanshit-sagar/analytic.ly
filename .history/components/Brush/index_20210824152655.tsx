...
const timeAgoInMsAtom: Atom<number> = atom((get) => getValueInMillis(timeAgoOptions[get(timeAgoAtom)]))
const timeAgoInMsWithQuantityAtom = atom((get) => get(timeAgoInMsAtom) * get(quantityAtom))
