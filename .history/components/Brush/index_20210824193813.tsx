...
const TickSize = () => {
    ...
    return (
        <SelectMenu 
           ...
           diickSizeOptions.filter((option: SelectionOption, _: number) => {
             ickSizeInMs = millify(option.label);
             TickSizeInMs>timeAgo || invalidate(currTickSizeInMs, quantify(currTickSizeInMs, timeAgo));
           })
        />
     )
}
