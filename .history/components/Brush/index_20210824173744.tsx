...
function invalidate(tickSize: boolean | undefined, quantifiedTime: number | undefined) {
    return tickSize!==undefined && quantifiedTime!==undefined ? ((tickSize > quantifiedTime ? true : false): false;
}
...
const invalidTickSizeAtom: Atom<boolean> = atom((get) => {
    return invalidate(get(tickSizeInMsAtom)!==undefined, get(timeAgoInMsWithQuantityAtom));
});
