...
const intervalOptions = [
    { id: 0, label: 'millisecond', value: 0, shortened: 'month' },
    { id: 1, label: 'second', value: 0, shortened: 'month' },
    { id: 2, label: 'min', value: 0, shortened: 'month' },
    { id: 3, label: 'hour', value: 0, shortened: 'month' },
    { id: 4, label: 'day', value: 0, shortened: 'month' },
    { id: 5, label: 'week', value: 0, shortened: 'month' },
