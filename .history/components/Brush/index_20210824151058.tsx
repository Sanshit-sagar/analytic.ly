...
const startAtAtom = atom(0)
const openStartAtom = atom(false)
const startInMillis = atom((get) => getValueInMillis(rangeOptions[get(startAtAtom)]))
...
const Range = () => {
    ...
    return (
        <SelectMenu 
             menuName={'Range'} 
             openAtom={openStartAtom} 
             selectedIndexAtom={startAtAtom} 
