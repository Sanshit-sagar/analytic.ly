...
function invalidate(tickSize: boolean | undefined, quantifiedTime: number | undefined) {
    return tickSize!==undefined ? tickSize > quantifiedTime : false;
}
...
const invalidTickSizeAtom: Atom<boolean> = atom((get) => {
    return invalidate(get(tickSizeInMsAtom)!==undefined ? get(tickSizeInMsAtom) > get(timeAgoInMsWithQuantityAtom) : false;
});
