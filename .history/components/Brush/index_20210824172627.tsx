...
function convertToMillis(ts: number) {
    getValueInMillis(timeAgoOptions[get(timeAgoAtom)].label) || -1
}

const timeAgoInMsAtom: Atom<number> = atom((get) => (getValueInMillis(timeAgoOptions[get(timeAgoAtom)].label) || -1))
