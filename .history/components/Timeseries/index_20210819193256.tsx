...
const Timeseries = ({ amount, range, interval, darkMode, updateAmount, updateRange, updateInterval, toggleDarkMode }: RangeInfo) => {
  ...
  return (
    <Box css={{ height: '550px', width: '650px', mt: '$1', mb: '$1', ml: '$2', padding: '$2', display: 'flex', flexDirection: 'column',  justifyContent: 'flex-start', alignItems: 'stretch' }}>
      <Flex css={{ fd: 'column', jc: 'flex-start', ai: 'center', gap: '$1' }}>
        ...
        <Box css={{ height: '405px', width: '675px' }}>
          <ParentSize>
            {({ width, height }) => {
              return (
                <Chart 
