...
const Chart = ({ 
  ...
  const { clicks, bounds, loading, error } = useClickHistoryForUser(amount, range, interval);
  ...
  return (
      <svg width={width} height={height}>
        ...
        <AnimatedAxis 
          ...
          tickValues={bounds.filter((b: string) => parseInt(b)%fifth==0 || parseInt(b)%fifth===0)}
        />
        <Tooltip<Datum>
