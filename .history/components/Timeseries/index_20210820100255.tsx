  ...
  return (
      <svg width={width} height={height}>
        ...
        <AnimatedAxis 
          orientation="bottom" 
          numTicks={2}  
          tickValues={clicks.map((click: any, i: number) => clicks[i].x).filter((cx: any, _: number) => parseInt(`${cx}`)%(clicks.length/4)===0)}
        ...
        <Tooltip<Datum>
          ...
          renderTooltip={({ tooltipData }) => {
            ...
            return (
                <Box css={{ minWidth: '200px', minHeight: '50px', padding: '$1 $1', br: '$1', border: 'thin solid black', bc: 'white' }}>
...
const Timeseries = ({ amount, range, interval, darkMode, updateAmount, updateRange, updateInterval, toggleDarkMode }) => {
  
  return (
    <Box css={{ height: '550px', width: '675px', mt: '$1', mb: '$1', ml: '$2', pl: '$2', display: 'flex', flexDirection: 'column',  justifyContent: 'flex-start', alignItems: 'stretch' }}>
