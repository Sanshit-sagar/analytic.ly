...
export const GraphDetailsAnnotation = ({ details }: { details: IGraphDetailsProps }) => {
    ...
    const subtitle = `Showing data between ${detailedStats[0]} and ${detailedStats[1]} ~${duration}. days`
    const subtitle2 = `Your slugs averaged ${globalMean} during this, with a high of ${detailedStats[7]}`
