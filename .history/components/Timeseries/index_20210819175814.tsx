...
const Timeseries = ({ amount, range, interval, darkMode, updateAmount, updateRange, updateInterval, toggleDarkMode }) => {
  ...
  return (
    <Box css={{ height: '550px', width: '800px', mt: '$2', mb: '$3', ml: '$2', padding: '$2', display: 'flex', flexDirection: 'column',  justifyContent: 'flex-start', alignItems: 'stretch', border: 'thin solid black', br: '$1' }}>
      <Flex css={{ fd: 'column', jc: 'flex-start', ai: 'center', gap: '$1' }}>
