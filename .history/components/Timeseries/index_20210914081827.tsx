...
const styleOptions = [
    { id: 0, value: 'linear', textValue: 'fitted', alt: undefined, icon: undefined },
    { id: 0, value: 'curve', textValue: 'curvy', alt: undefined, icon: undefined },
    { id: 0, value: 'linear', textValue: 'straight', alt: undefined, icon: undefined },
]
