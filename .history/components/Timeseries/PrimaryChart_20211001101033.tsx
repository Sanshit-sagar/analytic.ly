...
export default PrimaryChart = ({ height, width, margin }: SecondaryChartProps) => (
    <Box css={{ height: height, width: width, mt; margin.top, mb: margin.bottom, ml: margin.left, mr: margin.right }}>
        <ParentSize> 
            {({ height, width }) => {
                <FilteredDataView height={height} width={width} /> 
            }
        </ParentSize>
    </Box>
)
