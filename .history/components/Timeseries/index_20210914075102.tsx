...
export const Zoom = () => {
    const setZoomIndex = useUpdateAtom(timeseriesZoomIndexAtom)
    const zoom = useAtomValue(timeseriesZoomAtom)

    const handleChange = (updatedIndex: number) => setZoomIndex(updatedIndex)
