...
const DEFAULT_MARGIN = { top: 25, right: 40, bottom: 30, left: 35 };
  ...
  return (
      <svg width={width} height={height}>
        ...
        <AnimatedAxis 
          orientation="bottom" 
          numTicks={2}  
          tickValues={clicks.map((click: any, i: number) => clicks[i].x).filter((cx: any, _: number) => parseInt(`${cx}`)%(clicks.length/4)===0 && parseInt(`${cx}`))}
