...
import { ToolbarButtonGroup, ToolbarSeparator as ToolBAR } from '../../primitives/Toolbar'
...
const styleOptions = [
    { id: 0, value: 'linear', textValue: 'monotone', alt: undefined, icon: undefined, category: 'Curve Type'},
    { id: 0, value: 'curve', textValue: 'natural', alt: undefined, icon: undefined, category:  },
    { id: 0, value: 'monotone', textValue: 'natural', alt: undefined, icon: undefined, category:  },
    { id: 0, value: 'step', textValue: 'natural', alt: undefined, icon: undefined, category:  },
]
    ...
    return (
        ...
        >
            {styleOptions.map((styleOption, index) => (
                <Tooltip content={styleOption.value.toUpperCase()}>
                    <ToggleGroupButton
                        key={index}
