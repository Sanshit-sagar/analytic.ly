...
export const TimeAgo = () => {
    ...
    const [tick                        Size, setTickSize]

    const timesAgoOptions = [
        { id: 0, value: selectedIndex, textValue: `${selectedIndex}`,
        { id: 1, value: selectedIndex, textValue: `${selectedIndex}`,
        { id: 2, value: selectedIndex, textValue: `${selectedIndex}`,
        { id: 3, value: selectedIndex, textValue: `${selectedIndex}`,
        { id: 4, value: selectedIndex, textValue: `${selectedIndex}`,
    ]                          
    ...
    return (
        <SelectMenu 
             ...
             selectedTextValue={`${selectedValue}`}
