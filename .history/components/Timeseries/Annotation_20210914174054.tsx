...
export const GraphDetailsAnnotation = ({ details }: { details: IGraphDetailsProps }) => {
    ...
    const startDate =  getDate(detailedStats[0].value
    const endDate = getDate(detailedStats[1].value
    const formattedDate = (date: Date) => useFormattedDateRange(startDate, getDate(detailedStats[1].value)))
