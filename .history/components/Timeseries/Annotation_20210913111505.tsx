...
type connectorType = 'elbow' | 'straightLine'
...
export const GraphDetailsAnnotation = ({ details }: { details: IGraphDetailsProps }) => {
    ...
    const subtitle = `Showing data between ${detailedStats[0]} and ${detailedStats[1]} ~${detailedStats[2]}. days`
    const subtitle2 = `Your slugs averaged ${detailedStats[5]} during this, with a high of ${detailedStats[7]}`
