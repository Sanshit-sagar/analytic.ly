...
const Timeseries = () => {
  ...
  return (
        ...
        <Box style={{ height: '550px', width: '800px', mb: '$3', ml: '$2', display: 'flex', flexDirection: 'column',  justifyContent: 'flex-start', alignItems: 'stretch', border: 'thin solid black', br: '$1' }}>
          <Flex css={{ fd: 'column', jc: 'flex-start', ai: 'center', gap: '$1' }}>
