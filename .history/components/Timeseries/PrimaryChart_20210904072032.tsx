...
import { useGloballyConsistentColors } from '../../hooks/use'
...
const PrimaryChart: React.FC<PrimaryChartProps> = ({ 
    ...
    } = useGloballyConsistentColors(GRADIENT_ID)

    const { filteredDataState: { filteredData, bounds } } = useContext(MarketContext);
