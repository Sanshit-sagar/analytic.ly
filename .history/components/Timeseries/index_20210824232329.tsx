...
const DEFAULT_MARGIN = { top: 20, right: 5, bottom: 30, left: 25 };
...
const Timeseries = ({ quantity, timeAgo, tickSize, darkMode }: TimeseriesProps) => {
    const { clicks, minTimestamp, loading, error } = useClickHistoryForUser(quantity, timeAgo, interval)
