...
function invalidate(tickSize: number | undefined, quantifiedTime: number | undefin
    return tickSize!==undefined && quantifiedTime!==undefined ? (tickSize > quanti
}
function partition(isTickSizeInvalid: boolean, timeAgo: number | undefined, tickSi
