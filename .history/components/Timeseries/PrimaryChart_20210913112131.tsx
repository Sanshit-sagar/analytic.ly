...
import { XAxisLabel, YAxisLabel, GraphDetailsAnnotation } from './Annotation'
...
const bisectDate = bisector<Datum, Date>((d: Datum) => new Date(d.clickdate)).lef

export const accentColor  'rgba(200,200,200,1.0)'
export const background2 = 'rgba(255,0,100,1.0)'
