...
const presetOptions = [
    ...
    { id: 8, value: 1000 * 60 * 60 * 24 * 365, textValue: '1 Month', alt: '12 months (356 days)', icon: undefined }
];
...
const intervalLengthOptions: SelectionOption[] = [
    { id: 0, value: 1000, textValue: 'second' },
    { id: 1, value: 1000 * 60, textValue: 'minute' },
    { id: 2, value: 1000 * 60 * 60, textValue: 'hour' },
    { id: 3, value: 1000 * 60 * 60 * 24, textValue: 'day' },
    { id: 4, value: 1000 * 60 * 60 * 24 * 7, textValue: 'week' },
    { id: 5, value: 1000 * 60 * 60 * 60 * 7 * 30, textValue: 'month' },
];
