...
import { SpaceEvenlyHorizontallyIcon,  CalendarIcon, ChartIcon } from '@radix-ui/react-icons'
...
export const Statistic = () => {
    ...
    return (
        <SelectMenu
            ...
            selectedTextValue={<><ChartIcon /><Text> {statisticOptions[selectedIndex].value}</Text></>}
        />
    )
}
...
const Controller = () => {
    ...
    return (
        <Toolbar aria-label='Timeseries-controls' 
            css={{ height: 30, border: 'none', boxShadow: 'none', width: '98.5%' }}
        >
            <TimeSelectionGroup />
        </Toolbar>
    )
