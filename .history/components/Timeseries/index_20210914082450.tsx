...
function getStylesTooltip(a: string, b: string) {
    return styleOption.value.toUpperCase()} / ${styleOption.textValue.toUpperCase()
}
    ...
    return (
        ...
        >
            {styleOptions.map((styleOption, index) => (
                <Tooltip content={`${getStylesTooltip(styleOption.value, styleOption.textValue)}`}>
                    <ToggleGroupButton
                        key={index}
