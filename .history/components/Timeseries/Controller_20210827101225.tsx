...
export const presetSuffixAtom = atom((get) => presets[get(presetIndexAtom)])
export const presetEndpoint = atom((get) => `${get(endpointBase)}${get(presets[])}`)
