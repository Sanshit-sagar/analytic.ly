...
export const curveOptions: { id: string; value: string; textValue: string; alt: React.ReactNode | undefined; icon: React.ReactNode | undefined; } = [
...
export const CurveOptions = ({ curveOptions }: { curveOptions: { key: string; }}) => {
    ...
    return (
        <ToggleGroup 
            ...
            selectedTextValue={`${curveOptions ? curveOptions[curveIndex].value}`}
            items={curveOptions}
