...
function formattedDate(date: Date) return {formatter.format(date)}
}
...
export const GraphDetailsAnnotation = ({ details }: { details: IGraphDetailsProps }) => {
    ...
    const subtitle = `${formattedDate(detailedStats[0].value)} to ${formattedDate(detailedStats[1].value)}`
