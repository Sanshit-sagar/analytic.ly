...
import { theme1Dark, theme1Light, theme2Dark, theme3Dark } from '../../stitches.config'
    ...
    return (
        <IconButton
            ...
            onClick={() => {
                 ...
                 setTheme(theme === 'theme2-light' ? theme2Dark : theme === 'theme1-dark' ? theme1Light : theme==='theme2-dark' ? theme3Dark : theme2Dark)
            }} 
