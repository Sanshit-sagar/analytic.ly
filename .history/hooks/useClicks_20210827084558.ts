...
export const usePresets = (amount: string, range: string, interval: string) => {
    let endpoint = `http://localhost:3000/api/metrics/user/sanshit.sagar@gmail.com/tail/${amount}/year/weeks`
}