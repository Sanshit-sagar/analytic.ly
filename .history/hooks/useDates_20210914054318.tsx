...
const DEFAULT_OPTIONS = { dateStyle: 'short', timeStyle: 'short' };
...
function formatDateOrTimestampRange(start: Date, end: Date, options: typeof DEFAULT_OPTIONS): { start: string, end: string } {
...
const useDateRange = (rangeStart: Date | number, rangeEnd: Date | number) => {
    ...
    const formattedRange = formatDateOrTimestampRange(santizedRange.start, sanitizedRange.end, DEFAULT_OPTIONS);
}