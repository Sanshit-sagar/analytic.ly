...
import { ApiResponse } from '../components/SubMenus/interfaces';
...
// mutate: (key: string, value: string, payload: SavedUrchin): Promise<typeof ApiResponse<SavedUrchin[]>>

export const useMutationService = (key: string, value: string | undefined, payload: SavedUrchin | undefined): { service: Service<SavedUrchin[]>; mutate: () => void; } => {
    ...
    const mutate = (key: UrchinCategoryType, value: SavedUrchin, payload: SavedUrchin) => {
