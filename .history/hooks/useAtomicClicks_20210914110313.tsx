...
export const rangeAtom = atom((get) => get(rangeStrAtom).split(' ')[1])
...
export const usePresetClickstream = () => {
    ...
    const { data, error } = useSWR('http://localhost:3000/api/metrics/user/sanshit.sagar@gmail.com/tail/2/month/day');
