...
export const useGloballyConsistentColors = () => {
    ...
    try {
        return {
            ...
            neutral:  activeThemeColors.colors.accent.value,
            panel:  activeThemeColors.colors.accent.value,
            canvas:  activeThemeColors.colors.accent.value,
            loContrast:  activeThemeColors.colors.accent.value,
            hiContrast:  activeThemeColors.colors.accent.value,
            text:  activeThemeColors.colors.accent.value,
            accentContrast:  activeThemeColors.colors.accent.value,
            accentPressed:  activeThemeColors.colors.accent.value,
            accentHovered:  activeThemeColors.colors.accent.value,
