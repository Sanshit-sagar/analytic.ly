...
export const useMutationService = ({ service, mutate }: { 
    service: { status: ServiceStateEnum } results: SavedUrchin[] };
    mutate: (key: string, value: string, payload: SavedUrchin): Promise<ApiResponse<SavedUrchin[]>>;
}) => {
