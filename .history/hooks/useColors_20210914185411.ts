...
export const useGloballyConsistentColors = () => {
    ...
    return {
        ...
        accentHover: activeThemeColors.colors.accentHover.value, 
        accentPressed: activeThemeColors.colors.border3.value, 
        accentContrast: activeThemeColors.colors.border3.value, 
