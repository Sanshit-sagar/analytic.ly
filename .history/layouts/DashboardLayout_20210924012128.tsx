...
export interface IDashboardProps {
    children: any; 
    meta:  { 
        children: React.ReactNode | React.ReactElement | Element | undefined | null;
        meta: { pageMeta: any; }; 
    }; 
}
...
const DashboardLayout = ({ 
    ...
    const metadata = {
        ...
        cardImage:'https://og-image.now.sh/**Prism**%20with%20Next.js.png?theme=dark&md=1&fontSize=100px&images=https%3A%2F%2Fassets.verce',
       ...pageMeta,
    }
