...
const stitches = createCss({
  theme: {
    colors: {
        ...
        text: '$mauve1200',
        border: '$violet600',
        borderSelected: '$violet700',
        borderSelectedFocussed: '$violet800',
        borderSelectedFocussed
        accent: '$violet700',
        accentHover: '$violet800',
        accentPressed: '$violet900',
...
export const darkTheme = theme('dark-theme', {
    colors: {
        ...
        text: '$mauve1200',
        accent: '$violet800',
        accentHover: '$violet700',
        accentPressed: '$violet600',
        accentContrast: '$mauve1200',
        panel: '$mauve600',
        canvas: '$mauve100'
    }
