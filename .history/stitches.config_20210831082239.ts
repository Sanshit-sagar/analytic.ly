...
const stitches = createCss({
  theme: {
    ...
    hiContrast: '$slate100',
        oContrast: '$slate1200',
        anvas: 'rgba(245,245,244,1.0)',
        anel: 'rgba(255,255,255,1.0)',
        ransparentPanel: 'hsl(0 100% 100% / 97%)',
        hadowLight: 'rgba(230,230,230,0.9)',
        hadowDark: 'rgba(230,230,230,0.6)',
        ccent: 'rgba(255,154,0,1.0)',
        ccent2: 'rgba(255,0,48,1.0)',
        eutral: 'rgba(147,142,140,1.0)',
        ccentContrast: 'rgba(220,210,185,1.0)',
        ccentSecondary: 'rgba(50,255,150,0.6)'
    },
    fonts: {
...
export const darkTheme = theme('dark-theme', {
  colors: {
    ...
    hiContrast: '$slate100',
    loContrast: '$slate1200',
    canvas: 'rgba(245,245,244,1.0)',
    panel: 'rgba(255,255,255,1.0)',
    transparentPanel: 'hsl(0 100% 100% / 97%)',
    shadowLight: 'rgba(230,230,230,0.9)',
    shadowDark: 'rgba(230,230,230,0.6)',
    accent: 'rgba(255,154,0,1.0)',
    accent2: 'rgba(255,0,48,1.0)',
    neutral: 'rgba(147,142,140,1.0)',
    accentContrast: 'rgba(220,210,185,1.0)',
