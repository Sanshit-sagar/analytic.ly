...
export const Meter = ({ label, showValueLabel = !!label, value, minValue = 0, maxValue = 100 }: AriaMeterProps) => {
    ...
    return (
        <Box {...meterProps} style={{width: 500, height: 200, border: '2px solid white', br: '$2', bc: '$neutral' }}>
            ...
            <Box css={{height: 40, background: '$neutral' }}>
                <div style={{ width: barWidth, height: 40, background: 'green'}} />
            </Box>
        </Box>
    );
}