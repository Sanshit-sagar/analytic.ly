...
let ToggleTypes: ToggleType[] = [ToggleTyple.SINGLE, ToggleType.MULTIPE]
let Orientations: OrientationType[] = [Orientation.HORIZONTAL, Orientation.VERTICAL];
let Directions: DirectionType[] = [ Direction.LTR, Direction.RTL];
