...
export const RadioGroup = ({ radioItems, value, onChange }: { radioItems: { value: string; label: string }[]; value: string; onChange: (e: React.ChangeEventHandler<HTMLElement>)}) => {

    return (
        <PrimitiveRadioGroup value={radioItems[0].value} aria-label="Radio alternates">
