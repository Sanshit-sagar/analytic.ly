...
export const FocusablePopover = React.forwardRef(( props, ref ) => ( props: PopoverProps,ref: React.Ref<PopoverRef>) => {

    let { overlayProps } = useOverlay({ isOpen, onClose, shouldCloseOnBlur: false, isDismissable: false }); 
...
let ComboBoxStateProps = { 
    useComboBoxState({  defaultFilter: contains })
