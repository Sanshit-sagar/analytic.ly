...
export const ComboBox: React.FC<AriaComboBoxProps<ComboBoxItem>> = (props: AriaComboBoxProps<ComboBoxItem>) => {

    const { contains } = useFilter({ sensitivity: 'base' })
    let state: AriaListBoxOptions<ComboBoxItem> = useComboBoxState({...props, defaultFilter: contains});
