...
const Tree = memo<TreePropsType>(({ children, name, style, defaultOpen = false }) => {
    ...
    return (
        <TreeFrame>
            <Icon 
                style={{ ...toggle, opacity: children ? 1 : 0.3 }} onClick={() => setOpen(!isOpen)} />
    ...
    return (
        <TreeContainer>
            <Tree name='main' defaultOpen>
                <Tree name='subtree1' />
                <Tree name='subtree2 with children'>
                    <Tree name='sub-subtree1' />
                    <Tree name='sub-subtree2 with children'>
                        <Tree name='child1' style={{ color: colors.funky }} />
                        <Tree name='child2' style={{ color: colors.funky }} />
                        <Tree name='child3' style={{ color: colors.funky }} />
                    </Tree>
                </Tree>
            </Tree>
        </TreeContainer>
