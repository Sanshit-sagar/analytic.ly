...
const IconButtonWithTooltip = ({ label, onClick, icon }: { label: string; onClick: () => void; icon: 
    Element | ForwardRefExoticComponent<IconProps & RefAttributes<SVGSVGElement>> | undefined; }) => {
