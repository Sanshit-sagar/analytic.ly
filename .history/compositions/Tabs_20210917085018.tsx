...
const TabsContentWrapper = ({ index, value, size, children }: ITabsContentWrapperProps) => (isSmall(size) ? <TabsContentSmall key={index} value={value}/> : <TabsContentLarge key={index} value={value}/>
);
