...
export const presentEndpointAtom = atom('http://localhost:3000/api/metrics/user/sanshit.sagar@gmail.com/tail/1/month/weeks')
...
const PresetToggleButtons: React.FC<PresetToggleProps>  = ({ value, presets }: PresetToggleProps) => {
    ...
    const [selectedValue, setSelectedValue] = useAtom(value)
    const [presetEndpoint, setPresetEndpoint] = useAtom(activeEndpoint)
