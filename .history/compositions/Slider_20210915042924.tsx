...
export function RangeSlider(props: any & INumberFieldProps) {
    ...
    return (
        <BorderlessControlGroup>
            <Flex css={{ width: '100%', fd: 'row', jc: 'space-between', ai: 'flex-start', gap: '$2'}}>
                ...
                { props.withNumberField && props.thumbCount && <ThumbCountController numberFieldProps={...props.numberFieldProps} /> }
            </Flex>
