...
export const CustomTree = () => {
    ...
    let treeNodes: ITreeNode = [
        { id: '0', y: 0, x: 0, name: 'main', children: ['1', '2'], defaultOpen: true, style: nundefinedull, isLeaf: false },
        ...
        { id: '7', y: 3, x: 2, name: 'child3', children: [], defaultOpen: false, style: undefined, isLeaf: true, 
