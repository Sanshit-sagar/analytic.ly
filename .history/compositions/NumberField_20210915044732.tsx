...
export const NumberFieldGroup = (props: any) => {
    ...
    return (
        <div {...groupProps}>
            ...
            <IconButton size='1' variant='ghost' {...decrementProps} ref={incrRef}>
                <MinusIcon />
            </IconButton>
            <Input {...inputProps} ref={inputRef} />
            <IconButton size='1' variant='ghost' {...incrementProps} ref={decrRef}>
                <PlusIcon />
            </IconButton>
        </div>
    );
...
export const NumberField = (props: any) => {
    ...
    if(props.noControlGroup) return <NumberFieldGroup props={props} />;

    return (
        <ControlGroup>
            <Label> {props.label} </Label>
            <NumberFieldGroup props={props} />
        </ControlGroup>
    )
}
