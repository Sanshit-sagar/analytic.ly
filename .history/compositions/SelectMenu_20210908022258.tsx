...
interface IFormatContentProps { textValue: string; icon: any }
...
const SelectMenu = ({ index, setIndex, itemValue, itemTextValue, group }: ISelectMenuProps) => {
    const [isOpen, setIsOpen] = useState(false)
  
      const handleSelection = (selectedIndex: number): void => setIndex(selectedIndex)
      const formatContent = ({ textValue, icon }: IFormatContentProps) => (
        <> {icon || textValue} </>
      );
