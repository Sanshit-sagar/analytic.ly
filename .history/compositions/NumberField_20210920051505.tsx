...
type ValidationStateType = ValidationStateEnum.VALID | ValidationStateEnum.INVALID | 'description' 
const Message = ({ props, message }: { props: any; message: string; status: ValidationStateType }) => (
    <MessageText {...props}>
       <Text css={{ color: status===ValidationStateEnum.INVALID ? }} {message}
    </MessageText> 
); 
        ...
        <ControlGroup>
            ...
            {props.errorMessage && props.validationState===ValidationStateEnum.INVALID  ? (
                <Message 
                    ...
                    status={ValidationStateEnum.INVALID} 
                /> 
            ) : props.description ? 
                <Message 
                    props={descriptionProps} 
                    message={props.description} 
                    status={ValidationStateEnum.VALID}
                /> 
            : null}
        </ControlGroup>
    );
