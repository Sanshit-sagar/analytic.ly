...
export interface DoubleWrappedProps extends React.ComponentPropsWithRef<typeof ComboBoxProps<ComboBoxItem> {
    ref: React.RefObject<React.HTMLInputElement>;
    children: React.ReactNode; 
    props: typeof ComboBoxProps<ComboBoxItem>; 
}
