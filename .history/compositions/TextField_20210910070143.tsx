...
interface ITextFieldProps {
    label: string; 
    value: string; 
    onChange: (e: React.Chan) => void; 
    isValid: (text: string) => boolean;
}

const defaultValidator = (text: string) => text?.length ? true : false

export const TextField = ({ label, value, onChange, isValid = defaultValidator }: ITextFieldProps) => {
