...
interface IIconButtonWithTooltipProps {
    label: string; 
    onClick: () => void; 
    icon: Element | ForwardRefExoticComponent<React.IconProps & RefAttributes<SVGSVGElement>> | undefined; 
};
...
export const ControlledTreeNodeWithInput = ({ 
    ...
    node: ITreeNodeItem; 
    setNode: ((prevNode: ITreeNodeItem) => void); 
    removeNode: () => void; 
    placeholder: string; 
    label?: string; 
    icon: Element | ForwardRefExoticComponent<React.IconProps & React.RefAttributes<SVGSVGElement>> | undefined; 
}) => {
