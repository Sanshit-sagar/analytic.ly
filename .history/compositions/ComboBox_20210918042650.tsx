...
const Label = ({ labelProps }: { labelProps: React.HTMLAttributes<React.HTMLLabelElement> }) => (
    <Label {...labelProps}> {labelProps} </Label>
);

const Info = ({ labelProps }: { labelProps: React.HTMLAttributes<HTMLLabelElement> }) => (
    <Tooltip content={labelProps.label}> <InfoCircledIcon /> </Tooltip>
)
