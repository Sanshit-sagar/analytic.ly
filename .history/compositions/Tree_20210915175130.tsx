            ...
            <Tree name='main' defaultOpen>
                ...
                <Tree name='subtree2 with children'>
                    ...
                    <Tree name='sub-subtree2 with children'>
                        <Tree name='child1' style={{ textDecoration: 'strikethrough' }} />
                        <Tree name='child2' style={{ textDecoration: 'strikethrough' }} />
                        <Tree name='child3' style={{ textDecoration: 'strikethrough' }} />
                    </Tree>
                </Tree>
            </Tree>
        </TreeContainer>
