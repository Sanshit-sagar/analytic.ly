...
export const ComboBoxButton = React.forwardRef((
    props: Props,
    ref: React.Ref<Ref>, // the <Ref> is what maakes this immutable
) => (
...
const ComboBox: React.FC<ComboBoxComponentProps> = (props: ComboBoxComponentProps) => {
    ...
    let state: ComboBoxStateProps = useComboBoxState({ ...props, defaultFilter: i18nFilterType.CONTAINS })
  
    const inputRef = React.createRef<HTMLInputElement>()
    const listBoxRef = React.createRef<HTMLUListElement>()
    const popoverRef = React.creteRef<HTMLDivElement>()
