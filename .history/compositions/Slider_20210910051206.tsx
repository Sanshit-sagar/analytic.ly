...
const StyledColoredThumb = ({ isFocusVisible, isThumbDragging }: IStyledColoredThumbProps) => {
    return (
        <StyledThumb 
            css={{
                borderColor: isFocusVisible ? '$funky' :  state.isThumbDragging(index) ? '$border' : '$border3', 
