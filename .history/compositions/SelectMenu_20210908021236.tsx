...
const generateKeyFromValue = (group: string, a: string, b?: string) => `${controlGroupName}-${hashAB(a,b)}`
const generateKeyFromIndex = (group: string, i: number) => `${controlGroupName}-${hashI(i)}`
