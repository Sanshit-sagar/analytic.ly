...
type IGroupNameType =  { labelProps: React.HTMLAttributes<HTMLLabelElement>; label: string; };
...
const GroupName = ({ labelProps, label }: { labelProps: HTMLAttributes<HTMLElement>; label: string; }) => (
...
export const ComboBox = (props: ComboBoxProps<T extends object>) => {
    ...
    let listBoxRef = useRef<HTML(null)
