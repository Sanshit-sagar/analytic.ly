...
import { ValidationStateEnum } from '../primitives/ValidationStateEnum'
...
const ErrorMessage = ({ validationState, errorMessage, errorMessageProps }: IErrorMessage) => {
    const color = validationState===ValidationStateEnum.VALID ? 'green' : 'red'

    return (
        <ErrorMessageText {...errorMessageProps}>
            {errorMessage}
        </ErrorMessageText>
    )
}
