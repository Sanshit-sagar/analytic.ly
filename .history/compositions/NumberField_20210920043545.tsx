...
export function NumberField(props: any) {
    ...
    let inputRef:  React.MutableRefObject<HTMLInputElement | undefined> = React.useRef()
    let incrRef: React.MutableRefObject<HTMLButtonElement | undefined> = React.useRef()
    let decrRef: React.MutableRefObject<HTMLButtonElement | undefined> = React.useRef()
