...
export function NumberField(props: AriaNumberFieldProps) {
  ...
  let inputRef: RefObject<HTMLInputElement> = useRef<HTMLInputElement>();
  let incrRef: RefObject<HTMLInputElement> = useRef<HTMLInputElement>();
  let decRef: RefObject<HTMLInputElement> = useRef<HTMLElement>();
  let {
    labelProps,
    groupProps,
    inputProps,
