...
const ErrorMessage = ({ validationState = 'valid', errorMessage, errorMessageProps }: IErrorMessage) => (
...
export function NumberField(props: any) {
    ...
    let inputRef:  React.MutableRefObject<HTMLInputElement | undefined> = React.useRef(undefined)
    let incrRef: React.MutableRefObject<HTMLButtonElement | undefined> = React.useRef(undefined)
    let decrRef: React.MutableRefObject<HTMLButtonElement | undefined> = React.useRef(undefined)
