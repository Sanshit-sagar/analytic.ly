...
import { Item, Section, Collection } from "@react-stately/collections";
...
type ComboBoxState = Omit<ComboBoxComponentProps, "defaultFilter">;
...
function Option({ item, state, shouldUseVirtualFocus }: { item: ComboBoxItem; state: ComboBoxState; shouldUseVirtualFocus: boolean; }) {
    let ref = useRef()
