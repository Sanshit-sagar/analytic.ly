...
type cbButtonProps = { children: React.ReactNode; type: 'submit' | 'button' };
export type cbButtonRef = HTMLButtonElement
export const ComboBoxButton = React.ForwardedRef<cbButtonRef, cbButtonProps>((props, ref) => (
    <button ref={ref} className="comboBoxButton"
))
