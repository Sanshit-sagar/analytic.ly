...
interface IRadioGroup {
    { radioItems: { value: string; label: string }[]; value: string;
    
}

export const RadioGroup = ({ radioItems, value, handleChange }: { radioItems: { value: string; label: string }[]; value: string; onChange: (e: React.ChangeEventHandler<HTMLElement>)}) => {

    return (
        <PrimitiveRadioGroup value={value} onChange={handleChange} aria-label="Radio alternates">
