...
export const Tree = memo<TreePropsType>(({ children, name, defaultOpen = false }) => {
    ...
    return (
        <TreeFrame css={{ width: '400px' }}>
            <Flex css={{ width: '100%', fd: 'row', jc: 'flex-start', ai: 'flex-start', gap: '$1'}}>
                <Icon 
                    style={{ ...toggle, opacity: children ? 1 : 0.3 }} 
                    onClick={() => setOpen(!isOpen)} 
                />
                <Box css={{ width: '50%', padding: '$1',  border: '1px solid $border', '&:hover': { borderColor: '$border3' }}}>
