...
interface ICustomTextFieldProps {
    ...
    VALID_URL_REGEX: string;
}

export const CustomTextField = ({ destinationInputAtom, isDestinationInputValidAtom, VALID_URL_REGEX  }: ICustomTextFieldProps ) => {
    ...
    return (
        <ControlGroup>
            ...
            /> 
            <Validator isDestinationInputValidAtom={isDestinationInputValidAtom}, VALID_URL_REGEX />
        </ControlGroup>
    );
}
