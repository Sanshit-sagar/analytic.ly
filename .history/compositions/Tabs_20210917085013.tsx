...
const TabsContentWrapper = ({ index, value, size, children }: ITabsContentWrapperProps) => (
    return isSmall(size) ? <TabsContentSmall key={index} value={value}/> : <TabsContentLarge key={index} value={value}/>
);
