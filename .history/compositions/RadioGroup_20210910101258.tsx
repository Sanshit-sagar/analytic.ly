...
interface IRadioGroupProps {
    ...
    value: string;
    handleChange: (e: React.ChangeEventHandler<HTMLElement>) => void; 
};
...
export const RadioGroup = ({ radioItems, value, handleChange }: IRadioGroupProps) => {
    ...
    return (
        <PrimitiveRadioGroup 
            ...
            aria-label="Radio alternates"
        >
            {radioItems.map((ri: IRadioItem, idx: number) => {
                return (
                    <Flex key={idx}>
                        <RadioGroupRadio 
                            value={ri.value} 
