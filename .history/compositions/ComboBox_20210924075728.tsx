...
const CustomComboBoxProps =  <T extends {}>(
    props: React.PropsWithChildren<CustomComboBoxProps<T>>
  ) => {

    let { contains } = useFilter({ sensitivity: 'base' })
    let state = useComboBoxState({ ...props, defaultFilter: contains })
  
    let inputRef = React.useRef<HTMLInputElement | undefined>(null!)
    let listBoxRef = React.useRef<HTMLUListElement | undefined>(null!)
    let popoverRef = React.useRef<HTMLDivElement | undefined>(null!)
