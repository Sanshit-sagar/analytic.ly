...
export const TextField = (props: any) => {
    let {label} = props;
    let inputRef: React.RefObject<HTMLInputElement | TextAreaElement> = useRef<HTMLInputElement | TextAreaElement>()
    let {labelProps, inputProps} = useTextField(props, inputRef);

    const isValid = (unvalidatedText: string) => {
        unvalidatedText.match(props.validationRegex)
    }
