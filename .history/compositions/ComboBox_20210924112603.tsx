...
export const ComboBox: React.FC<ComboBoxComponentProps> = (props: ComboBoxComponentProps) => {
    ...
    let { children, items, item, s}: ComboBoxStateProps = useComboBoxState({ ...props, defaultFilter: contains })
    ...
    return (
        <ControlGroup>
            ...
            <FlexInlineBlock>
                <InputGroup> 
                    <StyledInput ref={inputRef} {...inputProps} isFocused={comboBoxState.isFocused} /> 
