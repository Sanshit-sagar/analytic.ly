...
interface IAbTestConfig {
    id: string; url: string; percentage: number;
}

interface ICustomTreeProps {
    slug: string;
    abtestingConfig: IAbTestConfig[];
}

const CustomTree = ({ slug, abtestingUrls }: ICustomTreeProps) => {

    return (
        <TreeContainer>
            <Tree name='main' defaultOpen>
                {abtestUrls.map((url: string, i: number) => (
                    <Tree name={}
                })}
