...
export function NumberField(props: any) {
    ...
    return (
        <ControlGroup>
            ...
            {props.description && !props.errorMessage && props.validationState===ValidationStateEnum.VALID  ? (
                <Description props={descriptionProps} message={props.description} />
            ) : props.errorMessage ? (
                <ErrorMessage props={errorMessageProps} message={props.errorMessage} status={ValidationStateEnum.VALID} /> 
            ) 
            : null}
        </ControlGroup>
    );
