...
export const NumberField = (props: AriaNumberFieldProps) => {
    ...
    const inputRef: React.MutableRefObject<HTMLInputElement> = useRef<HTMLInputElement | undefined>(undefined)
    const incrRef: React.MutableRefObject<HTMLButtonElement> = useRef<HTMLButtonElement | undefined>(undefined)
    const decrRef: MutableRefObject<HTMLButtonElement> = useRef<HTMLButtonElement | undefined>(undefined)
