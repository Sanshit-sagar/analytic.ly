...
{ id: string; index: number; label: string; value: string 
export const zoomOptions: IItem[] = [
    { id: '0', index: 0, value: 'magnify', label: 'zoom in', alt: undefined, icon: <ZoomInIcon /> },
    { id: '1', index: 1, value: 'reduce', label: 'zoom out', alt: undefined, icon: <ZoomOutIcon /> },
    { id: '2', index: 2, value: 'reset', label: 'reset', alt: undefined, icon: <ReloadIcon /> },
]
