...
const styleAtom = ((get) => styleOptions[get(styleIndexAtom)].value)
const styleTextValueAtom = ((get: (arg0: (get: any) => string) => string | number) => styleOptions[get(styleAtom)].textValue)
