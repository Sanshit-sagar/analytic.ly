...
export const hoveredMonthAtom = atom<Date | null>(undefined)
export const hoveredYearAtom = atom<Date | null>(undefined)
export const setHoveredMonthAtom = atom(
    null,
    (_get, set, hoveredMonth: number) => set(hoveredMonthAtom, new Date(hoveredMonth).getMonth())
);
