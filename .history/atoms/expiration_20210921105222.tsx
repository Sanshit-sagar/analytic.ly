...
type StageType = StageTypeEnum.UNINITIALIZED | StageTypeEnum.HOVER_START | StageTypeEnum.HOVER_END | StageTypeEnum.START | StageTypeEnum.END | StageTypeEnum.RESET 'start' | 'end' | 'hovering_end' | 'reset'
...
const stageAtom: WritableAtom<StageType, React.SetStateAction<Date>> = atom(
    (get) => {
