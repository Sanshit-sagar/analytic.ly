...
export const zoomOptions: ToggleDatum[] = [
    { id: '0', index: 0, value: 'magnify', label: 'zoom in', icon: <ZoomInIcon /> },
    { id: '1', index: 1, value: 'reduce', label: 'zoom out', icon: <ZoomOutIcon /> },
    { id: '2', index: 2, value: 'reset', label: 'reset', icon: <ReloadIcon /> },
]
...
export const styleOptions: IItem[] = [
    { id: '0', value: 'linear', textValue: 'polyline', alt: undefined, icon: undefined, },
    // category: 'Curve Type' },
