...
export const rangeOptions: IItem[] = [
    ...
    { id: 8, value: 1000 * 60 * 60 * 24 * 7 * 30, textValue: '3 Months', alt: '30 days', icon: undefined },
    { id: 9, value: 1000 * 60 * 60 * 24 * 365, textValue: '1 Year', alt: '12 months (365 days)', icon: undefined }
]
...
export const intervalOptions: IItem[] = [
    ...
    { id: '0', value: 1000 * 60 * 60, textValue: 'hour',  alt: undefined, icon: undefined  },
    { id: '0', value: 1000 * 60 * 60 * 24, textValue: 'day',  alt: undefined, icon: undefined  },
    { id: '0', value: 1000 * 60 * 60 * 24 * 7, textValue: 'week',  alt: undefined, icon: undefined  },
    { id: '0', value: 1000 * 60 * 60 * 60 * 7 * 30, textValue: 'month',  alt: undefined, icon: undefined  }
]
