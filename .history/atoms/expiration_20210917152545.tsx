...
export const hoveredStartDateAtom = atom<DA(undefined)

export const expirationResultsAtom = atom(
    (get) => {
        let expiryIsTruth = !!get(hoveredStartDateAtom)
        `Duration: ${expiryIsTruth ? useFormattedDate(${get(hoveredStartDateAtom)}) : 'no selection')}`
);