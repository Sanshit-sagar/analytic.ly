...
export const statisticOptions: IItem[] = [
    ...
    { id: '2', value: 'movingAverage', textValue: 'Moving Average', alt: undefined, icon: undefined },
]
...
export const timeseriesAtom = atom([])
...
export const windowSizeAtom = atom(
    (get) => {
        let totalRange = rangeOptions[get(rangeIndexAtom)].value
        let intervalSize = intervalOptions[get(intervalIndexAtom)].value
        return Math.round(rangeOptions[get(rangeIndexAtom)].value / (intervalOptions[get(intervalIndexAtom)].value * 10))
    }
);
