...
export const toMonth = atom((get) => new Date(get(currentYearAtom) + 1, get(currentMonthAtom) + 1)

export const monthAtom = atom((get) => get(currentMonthAtom)
export const yearAtom = atom((get) => get(currentYearAtom)
