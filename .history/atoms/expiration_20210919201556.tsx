...
export const fromAtom = atom(new Date(fromMonth))
export const toAtom = atom(null)
export const fromMonthAtom = atom(null)
export const fromYearAtom = atom(null)
...
export const fromDateAtom = atom(
    (get) => new Date(get(fromMonthAtom) || new Date(), get(fromYearAtom))
)
