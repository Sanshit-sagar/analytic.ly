...
export const abTestConfigsAtomsAtom = splitAtom(abTestingConfigsAtom)

const AbTestConfigsList = () => {
    const [abTestingConfigsAtom, removeAbTestingConfigsAtom] = useAtom(abTestingConfigsAtomsAtom)

    return (
        <ul>
            {abTestingConfigsAtom.map((abTestingConfigAtom) => (
                <AbTestConfig
                    abTestingConfigAtom={abTestingConfigAtom}
            ))
        </ul>
    )
}