...
export const recalcDataAtom: WritableAtom<null, Timeseries> = (
    null,
    (get: Atom<Datum[]>, set: React.SetStateAction<Timeseries>, update: Timeseries) => {
        ...
        set(cummulativeDataAtom, get(filteredDataAtom).map((datum: TimeseriesItem, i: number) => {
