...
import { IItem } from '../compositions/ToggleButtonsGroup'
...
export const zoomOptions: IItem[] = [
    { id: '0', value: 1, textValue: 'Magnify',  alt: undefined, icon: <ZoomInIcon /> },
    { id: '1', value: -1, textValue: 'Reduce',  alt: undefined,  icon: <ZoomOutIcon /> },
    { id: '2', value: 0, textValue: 'Reset', alt: undefined, icon: <ReloadIcon /> },
]
