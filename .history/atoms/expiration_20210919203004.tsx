...
export const fromAtom = atom<Date>(new Date(fromMonth))
export const toAtom = atom<Date | null>(null)
export const fromMonthAtom = atom<number | null>(new Date(fromMonth).getMonth())
export const fromYearAtom = atom<number | null>(new Date(toMonth).getFullYear())
export const enteredToAtom = atom<Date | null>(null)
...
export const hoveredStartDateAtom: Atom<Date | undefined> = atom(undefined)
