...
export const zoomOptions: IItem[] = [
...
export const rangeOptions: IItem[] = [
    ...
    { id: '0', value: 1000 * 60 * 10, textValue: '10 Minutes', alt: undefined, icon: undefined },
    { id: '0', value: 1000 * 60 * 30, textValue: '30 Minutes', alt: undefined, icon: undefined },
    { id: '0', value: 1000 * 60 * 60, textValue: '1 Hour', alt: '60 Minutes', icon: undefined },
    { id: '0', value: 1000 * 60 * 60 * 6, textValue: '6 Hours', alt: '360 Minutes', icon: undefined },
    { id: '0', value: 1000 * 60 * 60 * 12, textValue: '12 Hours', alt: '720 Minutes', icon: undefined },
    { id: '0', value: 1000 * 60 * 60 * 24, textValue: '1 Day', alt: '1440 Minutes (24 hours)', icon: undefined },
    { id: '0', value: 1000 * 60 * 60 * 24 * 7, textValue: '1 Week', alt: '9960 Minutes (156 hours)', icon: undefined },
    { id: '0', value: 1000 * 60 * 60 * 24 * 7 * 30, textValue: '1 Month', alt: '30 days', icon: undefined },
    { id: '0', value: 1000 * 60 * 60 * 24 * 7 * 30, textValue: '3 Months', alt: '30 days', icon: undefined },
    { id: '0', value: 1000 * 60 * 60 * 24 * 365, textValue: '1 Year', alt: '12 months (365 days)', icon: undefined }
]
