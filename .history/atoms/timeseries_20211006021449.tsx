...
export const INIT_WINDOW_SCALE_FACTOR = 0.25 
...
export const windowSizeAtom = atom(
    ...
    (get, set, update: number) => { 
        ...
        // and 1000 => 1 window = 7, 30 days (as in the week/month options) -> fix tooltip dates  
        ...
        set(movingAvgDataAtom, get(filteredDataAtom).map((datum: Datum, i: number) => {
            ...
            let updatedWindowSize = get(windowerAtom) 

            if(get(windowerAtom) && i > updatedWindowSize) {
                runningTotal -= get(filteredDataAtom)[i-get(windowerAtom)].clickscore
                start++;
            }
            ...
            return {
                ...
                clickscore: runningTotal/get(windowerAtom),
...
export const recalcDataAtom = atom(
    ...
    (get, set, update: Datum[]) => {
        ...
        set(movingAvgDataAtom, get(filteredDataAtom).map((datum: Datum, index: number) => {
            ...
            if(index - start > get(windowerAtom)) {
