...
export const curveStyleAtom = atom((get) => styleOptions[get(styleIndexAtom)].value)
export const curveStyleTextValueAtom = atom((get) => styleOptions[get(styleIndexAtom)].textValue)

export const timeseriesZoomIndexAtom = atom(1)
export const timeseriesZoomTextValueAtom = atom((get) => zoomOptions[get(timeseriesZoomIndexAtom)].textValue)
