...
export const selectedAbTestConfigsAtom = atom(
    ...
    (get, set, abTestConfigItemAtom: AbTestConfigItemAtom | null) => {
        ...
        if(abTestConfigItemAtom) {
            const { id, name, primaryValue, secondaryValue, valid } = get(abTestConfigItem)
            set(idAtom, id),
            set(nameAtom, name),
...
export const createAbTestConfigAtom = atom(
    ...
    (get, set) => {
        ...
        const abTestConfigsAdditionAtom = abTestConfigAtomFactory(abTestConfigsCount + 1)
        set(abTestConfigsAtom, (prev) => [...prev, abTestConfigsAddition])
