...
export const setAbTestConfigsAtom = atom (
    ...
    (get, set, testGroupCount: number) => {
        ...
        let numDeleted = get(deletedConfigsAtom)?.length
        ...
        if(configs.length < testGroupCount) {
            ...
            let toAdds = get(abTestConfigsAtom)?.length - testGroupCount

            set(deletedConfigsAtom,  ...get(abTestConfigsAtom).splice(configs.length - testGroupCount)
                    ...get(deletedConfigsAtom), 
                    ...get(abTestConfigsAtom).splice(toAdds)
                ]
            } else {
