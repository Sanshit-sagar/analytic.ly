...
export const abTestConfigAtom = atom([...abTestConfigAtomsFactory(ATOM_ID_START, INIT_ATOMS_COUNT)])
export const abTestConfigAtomsAtom = splitAtom(abTestConfigAtom)

export const incrementAbTestConfigsAtom = atom(
    null,
    (get, set) => {
        let configs = get(abTestConfigAtom)

        let newConfig = abTestConfigAtomFactory(configs.length, 2)
        set(abTestConfigsAtom, [...configs, {...newConfig}])
    }
); 

export type AbTestConfigType = typeof abTestConfigAtom
