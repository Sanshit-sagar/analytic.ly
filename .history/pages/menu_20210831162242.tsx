...
const activeTabIndexAtom = atom(0)
const activeTabIdAtom = atom((get) => submenus[get(activeTabIndexAtom)].id)
const activeTabLabelAtom = atom((get) => submenus[get(activeTabIndexAtom)].label)
const activeTabValueAtom = atom((get) => submenus[get(activeTabIndexAtom)].value)
