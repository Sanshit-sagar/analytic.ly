...
const Home = () => {
  ...
  return (
    <main style={{ height: '100vh', width: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', alignItems: 'center', margin: 0, padding: '10px 5px 10px 5px', overflowY: 'scroll' }}>
