...
const Home = () => {
  ...
  return (
    <main style={{ height: '100vh', width: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', margin: 0, padding: '10px 5px 10px 5px', overflowY: 'hidden' }}>
        <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', width: '100%' }}>
          <ParentSize>{({ width, height }) => <Bars width={width} height={height} /> }</ParentSize>
        </div>
