...
import { 
    pageSizeTextValueAtom, 
    pageSizeIndexAtom,
    pageSizeValueAtom 
} from '../components/Table/ActionGroups/PageSizeSelector'
...
const ClicksTable = ({ 
    ...
    const updatedPageSize = useAtomValue(pageSizeValueAtom)
...
const TabulatedClicks = () => {
    ...
    const { data, error, mutate, size, setSize, isValidating }: IInfinitelyLoadedClicks = useSWRInfinite(
        (pageNumber: number) => {
