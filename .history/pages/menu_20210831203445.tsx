...
const submenus = [
    ...
    { id: 'timeframe', value: 'timeframe', label: 'Timeframe', content: <TimeframeTabContent />, icon: <ClockIcon css={{ color: 'red' }} />},
]
                    ...
                    {submenus.map((submenu, i) => {
                        return (
                            <TabsTrigger 
                                ...
                                value={submenu.value} 
                            >
                                <Flex css={{ width: '100%', fd: 'row', jc: 'space-between', ai: 'stretch', gap: '$3' }}></Flex>
