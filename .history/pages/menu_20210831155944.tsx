...
const submenus = [
    { id: 'tab1', value: 'destinationLink', label: 'Destination', content: <DestinationLinkTabContent />, icon: null, },
    { id: 'tab2', value: 'chooseSlug', label: 'Slug Choice', content: <ChooseSlugTabContent />, icon: null },
    { id: 'tab3', value: 'timeframe', label: 'Ti'}
]
