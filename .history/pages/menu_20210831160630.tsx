...
const TimeframeTabContent = () => <Text size='1' as='span'> Timeframe Tab Content Here </Text>
const SlugTabContent = () => <Text size='1' as='span'> Slug Tab Content Here </Text>
const DestinationTabContent = () => <Text size='1' as='span'> Destination Tab Content Here </Text>
                ...
                {submenus.map((submenu, i) => {
                    return (
                        <TabsContent value='tab1'>
                            <Flex css={{ fd: 'column', jc: 'space-between', ai: 'stretch', gap: '$2' }}></Flex>
