...
import { FieldSet, Label, Input } from '../primitives/FieldSet'
...
const DestinationTabContent = () => {
    ...
    const handleInputChange = (event: React.ChangeEventHandler<HTML) => {
    ...
    return (
        <Flex css={{ fd: 'column', jc: 'flex-start', ai: 'stretch', gap: '$1'}}>
            ...
            <Separator css={{ color: '$accent', bc: '$accentContrast', width: '400px'}} /> 
            <FieldSet>
