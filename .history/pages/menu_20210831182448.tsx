...
const DestinationTabContent = () => {
    return ( 
        <Box css={{ padding: '$3', border: 'thin solid', borderColor: '$loContrast', br: '$2' }}>
            <Separator orientation='horizontal' />

            <Text> Your Destination Goes Here ___</Text>
        </Box>
    );
}
...
const submenus = [
    ...
    { id: 'timeframe', value: 'timeframe', label: 'Timeframe', content: <TimeframeTabContent />, icon: },
]
