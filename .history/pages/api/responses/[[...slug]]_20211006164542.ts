...
function extract(payloads: ResponsePayload[], property: keyof ResponsePayload) {
    return payloads.map((payload: ResponsePayload) =>, i) => {
        return payload.hasOwnProperty(property) ? parseInt(payload[property]) : ''
    })
}
