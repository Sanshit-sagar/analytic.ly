...
type PrimitiveHeaderProperty = string | number;
type ProcessedPrimitiveHeaderProperty = PrimitiveHeaderProperty | undefined;
type ResponseProp = ProcessedPrimitiveHeaderProperty

type HeaderSubset = PrimitiveHeaderProperty[];


type SummaryStats<HeaderPrimitive> = {
    min: PHP;
    max: PHP;
    minIndex: T | undefined;
    maxIndex: T | undefined;
    mean: T | undefined;
    mode: T
}
