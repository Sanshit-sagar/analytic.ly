...
async function formatClickstream(slug: string, amount: number, interval: string, range: string): RawClickstream): ClickstreamDetails {
...
function getClickstream(slug: string, amount: number, interval: string, range: string): ClickstreamDetails {
    ...
    return formatClickstream({ views, minTimestamp, maxTimestamp, amount, range, interval })
}
