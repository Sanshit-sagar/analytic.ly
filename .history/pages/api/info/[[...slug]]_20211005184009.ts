...
export default getHandler()
    ...
    .get('/api/info/diff/:amount/:range/:interval/:slug1/:slug2', async (req: NextApiRequestExtended, res: NextApiResponse) => {
        let email = 'sanshit.sagar@gmail.com'
        ...
        slugs.map((slug: string, index: number) => {
            ...
            promises.push(new Promise((resolve, reject) => {
                getFormattedClickstream({
                    ...
                    return reject(new Error(`Could not complete ${remainingIndicies}`))
