...
export default getHandler()
    ...
    .get('/api/suggestions/custom', async (req: NextApiRequestExtended, res: NextApiResponse) => {
        ...
        try {
            let suggestion = await generateCustomizedSlug(separator, lang, symbols, wordsToMantainCaseFor, maintainCase, titleCase, truncate, uric, uricNoSlash, mark, wordsTo)
        }
    });
