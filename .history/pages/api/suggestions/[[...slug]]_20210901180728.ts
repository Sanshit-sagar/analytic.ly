...
export default getHandler()
    ...
    .get('/api/suggestions/custom', async (req: NextApiRequestExtended, res: NextApiResponse) => {
        ...
        try {
            let speakingUrlOpts = await normalizeOptions({ 
                separator, lang, symbols, wordsToMantainCaseFor, maintainCase, titleCase, truncate, uric, uricNoSlash, mark, wordsToMantainCaseFor })
