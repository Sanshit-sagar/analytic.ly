...
async function hmgetQuery(key: string, secondaryKey: string) {
...
// }; 
async function getDetailsForSlugWithUser(email: string, slug: string) {
...
export default getHandler()
    .get('/api/config/slug/:slug', requireSession(async (req: NextApiRequestExtended, res: NextApiResponse) => {
        ...
        try {
            ...
            const data = await getDetailsForSlugWithUser(email, slug)
