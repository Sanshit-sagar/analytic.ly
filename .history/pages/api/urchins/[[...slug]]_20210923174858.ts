import { NextApiResponse, NextApiResponse } from 'next'
...
export default getHandler(req: NextApiRequestExtended, res: NextApiResponse)
    ...
    .get('/api/urchins/info', async (req: NextApiRequestExtended, res: NextApiResponse) => {
        res.status(200).json({  
            id: req.userId 
        })
    });