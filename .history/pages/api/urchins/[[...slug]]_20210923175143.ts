...
export default getHandler()
    ...
    .get('/api/urchins/info', requireSession(handler: Function, { onError }?: MiddlewareOptions | undefined): async (req: WithSessionProp<NextApiRequestExtended>, res: NextApiResponse) => {
        res.statusCode = 200;
