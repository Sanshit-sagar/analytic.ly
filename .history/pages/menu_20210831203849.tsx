...
const submenus = [
    ...
    { id: 'cache', value: 'cache', label: 'Blacklists', content: <SlugTabContent />, icon: <Link2Icon /> },
    { id: 'qrCodes', value: 'qrCodes', label: 'Blacklists', content: <SlugTabContent />, icon: <Link2Icon /> },
    { id: 'share', value: 'share', label: 'Blacklists', content: <SlugTabContent />, icon: <Link2Icon /> },
]
