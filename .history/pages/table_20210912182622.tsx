...
const TabulatedClicks = () => {
    ...
    const clicks: any[] = data && data[0] && data[0].page ? [].concat(...data[0].page) : [];
    const isLoadingInitialData = !data && !error
    const isLoadingMore = isLoadingInitialData || (size > 0 && data && data[size-1] && data[0].page && typeof data[size-1]===UNDEFINED)
