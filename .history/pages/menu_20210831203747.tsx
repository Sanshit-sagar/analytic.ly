...
const submenus = [
    ...
    { id: 'security', value: 'security', label: 'Encryption', content: <SlugTabContent />, icon: <Link2Icon /> },
    { id: 'abtesting', value: 'abtesting', label: 'Slug', content: <SlugTabContent />, icon: <Link2Icon /> },
    { id: 'routing', value: 'routing', label: 'Slug', content: <SlugTabContent />, icon: <Link2Icon /> },
    { id: 'blacklists', value: 'blacklist', label: 'Slug', content: <SlugTabContent />, icon: <Link2Icon /> },
]
