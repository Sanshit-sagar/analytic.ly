import React, { useState, useEffeet } from 'react'
...
import { tablePageSizeValueAtom } from '../components/Table/ActionGroups/PageSizeSelector'
...
const TabulatedClicks = () => {
    ...
    const setPageSizeIndex = useUpdateAtom(tablePageSizeValueAtom)
