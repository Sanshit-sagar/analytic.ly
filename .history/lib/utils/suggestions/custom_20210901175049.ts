...
export function normalizeOptions(rawOptions: IRawOptions) {
    ...
    const normalizedTitleCase: string[] | boolean | undefined = rawOptions.titleCase
    normalizedTitleCase  = normalizedTitleCase || (hasOmittedWords && [...rawOptions.
wordsToMantainCaseFor]) || undefined,
