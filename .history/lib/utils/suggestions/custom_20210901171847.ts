...
const REGEXES = {  
    { id: 0, name: 'alphanumeric', regex: /0-9a-zA-Z/, description: 'Alphabets (uppercase and lowercase) and single digits (0-9).', source: '' },
    { id: 1, name: 'uric', regex: /0-9a-zA-Z/, description: 'Characters that are used as delimitters in URIs',  source: 'https://datatracker.ietf.org/doc/html/rfc2396' },
};
