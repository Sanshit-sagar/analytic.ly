...
const DEFUALT_PAGE_SIZE

export const paginateClickstream = async (email: string | string[], lastSeenId: number | undefined, queryAmount: number | undefined): Promise<any> => {
    let page: any[];
